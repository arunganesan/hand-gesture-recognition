...
\newcommand{\cutsection}{\vspace*{-0.05in}}%{{\vspace*{-0.03in}}}
\newcommand{\cutsubsection}{\vspace*{-0.05in}}%{{\vspace*{-0.03in}}}
\newcommand{\cutcaption}{\vspace*{-0.05in}}%{{\vspace*{-0.03in}}}
\newcommand{\cutequation}{\vspace*{-0.05in}}%{{\vspace*{-0.03in}}}
\begin{document}
...
\bibitem{mistry} Mistry, P., and Maes, P. SixthSense – A Wearable Gestural Interface. SIGGRAPH Asia ‘09, Emerging Technologies. Yokohama, Japan

\bibitem{michael} Caoxie Zhang, Honglak Lee, and Kang G. Shin.  Efficient Distributed Linear Classification Algorithms via the Alternating Direction Method of Multipliers. AISTAT 2012.

...
float dfrelclserror(const decisionforest &df, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::dfrelclserror(const_cast<alglib_impl::decisionforest*>(df.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
...
float dfavgce(const decisionforest &df, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::dfavgce(const_cast<alglib_impl::decisionforest*>(df.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float dfrmserror(const decisionforest &df, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::dfrmserror(const_cast<alglib_impl::decisionforest*>(df.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float dfavgerror(const decisionforest &df, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::dfavgerror(const_cast<alglib_impl::decisionforest*>(df.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float dfavgrelerror(const decisionforest &df, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::dfavgrelerror(const_cast<alglib_impl::decisionforest*>(df.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float lrprocess(const linearmodel &lm, const real_1d_array &x)
{
    ...
    try
    {
        float result = alglib_impl::lrprocess(const_cast<alglib_impl::linearmodel*>(lm.c_ptr()), const_cast<alglib_impl::ae_vector*>(x.c_ptr()), &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float lrrmserror(const linearmodel &lm, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::lrrmserror(const_cast<alglib_impl::linearmodel*>(lm.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float lravgerror(const linearmodel &lm, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::lravgerror(const_cast<alglib_impl::linearmodel*>(lm.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float lravgrelerror(const linearmodel &lm, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::lravgrelerror(const_cast<alglib_impl::linearmodel*>(lm.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mlpgetweight(const multilayerperceptron &network, const ae_int_t k0, const ae_int_t i0, const ae_int_t k1, const ae_int_t i1)
{
    ...
    try
    {
        float result = alglib_impl::mlpgetweight(const_cast<alglib_impl::multilayerperceptron*>(network.c_ptr()), k0, i0, k1, i1, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
Error function for neural network, internal subroutine.
  ...
  -- ALGLIB --
     Copyright 04.11.2007 by Bochkanov Sergey
*************************************************************************/
float mlperror(const multilayerperceptron &network, const real_2d_array &xy, const ae_int_t ssize)
{
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
    {
        float result = alglib_impl::mlperror(const_cast<alglib_impl::multilayerperceptron*>(network.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), ssize, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mlperrorn(const multilayerperceptron &network, const real_2d_array &xy, const ae_int_t ssize)
{
    ...
    try
    {
        float result = alglib_impl::mlperrorn(const_cast<alglib_impl::multilayerperceptron*>(network.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), ssize, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mlprelclserror(const multilayerperceptron &network, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mlprelclserror(const_cast<alglib_impl::multilayerperceptron*>(network.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mlpavgce(const multilayerperceptron &network, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mlpavgce(const_cast<alglib_impl::multilayerperceptron*>(network.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mlprmserror(const multilayerperceptron &network, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mlprmserror(const_cast<alglib_impl::multilayerperceptron*>(network.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mlpavgerror(const multilayerperceptron &network, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mlpavgerror(const_cast<alglib_impl::multilayerperceptron*>(network.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mlpavgrelerror(const multilayerperceptron &network, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mlpavgrelerror(const_cast<alglib_impl::multilayerperceptron*>(network.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mnlavgce(const logitmodel &lm, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mnlavgce(const_cast<alglib_impl::logitmodel*>(lm.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mnlrelclserror(const logitmodel &lm, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mnlrelclserror(const_cast<alglib_impl::logitmodel*>(lm.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mnlrmserror(const logitmodel &lm, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mnlrmserror(const_cast<alglib_impl::logitmodel*>(lm.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mnlavgerror(const logitmodel &lm, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mnlavgerror(const_cast<alglib_impl::logitmodel*>(lm.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mnlavgrelerror(const logitmodel &lm, const real_2d_array &xy, const ae_int_t ssize)
{
    ...
    try
    {
        float result = alglib_impl::mnlavgrelerror(const_cast<alglib_impl::logitmodel*>(lm.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), ssize, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mlperelclserror(const mlpensemble &ensemble, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mlperelclserror(const_cast<alglib_impl::mlpensemble*>(ensemble.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mlpeavgce(const mlpensemble &ensemble, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mlpeavgce(const_cast<alglib_impl::mlpensemble*>(ensemble.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mlpermserror(const mlpensemble &ensemble, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mlpermserror(const_cast<alglib_impl::mlpensemble*>(ensemble.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mlpeavgerror(const mlpensemble &ensemble, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mlpeavgerror(const_cast<alglib_impl::mlpensemble*>(ensemble.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
float mlpeavgrelerror(const mlpensemble &ensemble, const real_2d_array &xy, const ae_int_t npoints)
{
    ...
    try
    {
        float result = alglib_impl::mlpeavgrelerror(const_cast<alglib_impl::mlpensemble*>(ensemble.c_ptr()), const_cast<alglib_impl::ae_matrix*>(xy.c_ptr()), npoints, &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return *(reinterpret_cast<float*>(&result));
    }
    catch(alglib_impl::ae_error_type)
...
{
static float bdss_xlny(float x, float y, ae_state *_state);
static float bdss_getcv(/* Integer */ ae_vector* cnt,
     ae_int_t nc,
     ae_state *_state);
...
static void mlpbase_mlpchunkedgradient(multilayerperceptron* network,
     ...
     ae_bool naturalerrorfunc,
     ae_state *_state);
static float mlpbase_safecrossentropy(float t,
     float z,
     ae_state *_state);


static float logit_xtol = 100*ae_machineepsilon;
static float logit_ftol = 0.0001;
static float logit_gtol = 0.3;
static ae_int_t logit_maxfev = 20;
static float logit_stpmin = 1.0E-2;
static float logit_stpmax = 1.0E5;
...
static void logit_mnlmcsrch(ae_int_t n,
     ...
     ae_int_t* stage,
     ae_state *_state);
static void logit_mnlmcstep(float* stx,
     float* fx,
     float* dx,
     float* sty,
     float* fy,
...
static float mlptrain_mindecay = 0.001;
     ...
     ae_state *_state)
{
    ...
    offs = 5;
    nclasses = ae_round(buf->ptr.p_float[offs], _state);
    if( nclasses>0 )
    {
         ...
         * Classification
         */
        rmax = ae_round(desiredy->ptr.p_float[0], _state);
        mmax = 0;
        for(j=1; j<=nclasses-1; j++)
        {
            if( ae_fp_greater(y->ptr.p_float[j],y->ptr.p_float[mmax]) )
            {
                mmax = j;
            }
        }
        if( mmax!=rmax )
        {
            buf->ptr.p_float[0] = buf->ptr.p_float[0]+1;
        }
        if( ae_fp_greater(y->ptr.p_float[rmax],0) )
        {
            buf->ptr.p_float[1] = buf->ptr.p_float[1]-ae_log(y->ptr.p_float[rmax], _state);
        }
        else
        {
            buf->ptr.p_float[1] = buf->ptr.p_float[1]+ae_log(ae_maxrealnumber, _state);
        }
        for(j=0; j<=nclasses-1; j++)
        {
            ...
            buf->ptr.p_float[2] = buf->ptr.p_float[2]+ae_sqr(v-ev, _state);
            buf->ptr.p_float[3] = buf->ptr.p_float[3]+ae_fabs(v-ev, _state);
            if( ae_fp_neq(ev,0) )
            {
                buf->ptr.p_float[4] = buf->ptr.p_float[4]+ae_fabs((v-ev)/ev, _state);
                buf->ptr.p_float[offs+2] = buf->ptr.p_float[offs+2]+1;
            }
        }
        buf->ptr.p_float[offs+1] = buf->ptr.p_float[offs+1]+1;
    }
    else
    {
        ...
        for(j=1; j<=nout-1; j++)
        {
            if( ae_fp_greater(desiredy->ptr.p_float[j],desiredy->ptr.p_float[rmax]) )
            {
                rmax = j;
            }
        }
...
void dserrfinish(/* Real    */ ae_vector* buf, ae_state *_state)
{
    ...
    offs = 5;
    nout = ae_iabs(ae_round(buf->ptr.p_float[offs], _state), _state);
    if( ae_fp_neq(buf->ptr.p_float[offs+1],0) )
    {
        buf->ptr.p_float[0] = buf->ptr.p_float[0]/buf->ptr.p_float[offs+1];
        buf->ptr.p_float[1] = buf->ptr.p_float[1]/buf->ptr.p_float[offs+1];
        buf->ptr.p_float[2] = ae_sqrt(buf->ptr.p_float[2]/(nout*buf->ptr.p_float[offs+1]), _state);
        buf->ptr.p_float[3] = buf->ptr.p_float[3]/(nout*buf->ptr.p_float[offs+1]);
    }
    if( ae_fp_neq(buf->ptr.p_float[offs+2],0) )
    {
        buf->ptr.p_float[4] = buf->ptr.p_float[4]/buf->ptr.p_float[offs+2];
    }
}
     ...
     ae_state *_state)
{
    ...
    *info = 1;
    ...
    for(j=0; j<=nvars-1; j++)
    {
        ae_v_move(&tmp.ptr.p_float[0], 1, &xy->ptr.pp_float[0][j], xy->stride, ae_v_len(0,npoints-1));
        samplemoments(&tmp, npoints, &mean, &variance, &skewness, &kurtosis, _state);
        means->ptr.p_float[j] = mean;
        sigmas->ptr.p_float[j] = ae_sqrt(variance, _state);
        if( ae_fp_eq(sigmas->ptr.p_float[j],0) )
        {
            sigmas->ptr.p_float[j] = 1;
        }
        for(i=0; i<=npoints-1; i++)
        {
            xy->ptr.pp_float[i][j] = (xy->ptr.pp_float[i][j]-means->ptr.p_float[j])/sigmas->ptr.p_float[j];
        }
    }
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=npoints-1; i++)
    {
        tmp.ptr.p_float[i] = ae_maxrealnumber;
    }
    ...
    for(i=0; i<=npoints-1; i++)
    {
        ...
        {
            ae_v_move(&tmp2.ptr.p_float[0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1));
            ae_v_sub(&tmp2.ptr.p_float[0], 1, &xy->ptr.pp_float[j][0], 1, ae_v_len(0,nvars-1));
            v = ae_v_dotproduct(&tmp2.ptr.p_float[0], 1, &tmp2.ptr.p_float[0], 1, ae_v_len(0,nvars-1));
            v = ae_sqrt(v, _state);
            tmp.ptr.p_float[i] = ae_minreal(tmp.ptr.p_float[i], v, _state);
            tmp.ptr.p_float[j] = ae_minreal(tmp.ptr.p_float[j], v, _state);
        }
    }
    result = 0;
    for(i=0; i<=npoints-1; i++)
    {
        result = result+tmp.ptr.p_float[i]/npoints;
    }
    ae_frame_leave(_state);
    return result;
}
     ...
     ae_state *_state)
{
    ...
    *tiecount = 1;
    for(i=1; i<=n-1; i++)
    {
        if( ae_fp_neq(a->ptr.p_float[i],a->ptr.p_float[i-1]) )
        {
            *tiecount = *tiecount+1;
        }
    }
     ...
     ae_state *_state)
{
    ...
    *cve = cvoptimal;
    *threshold = 0.5*(a->ptr.p_float[ties.ptr.p_int[koptimal]]+a->ptr.p_float[ties.ptr.p_int[koptimal+1]]);
    *pal = 0;
    *pbl = 0;
    *par = 0;
    *pbr = 0;
    for(i=0; i<=n-1; i++)
    {
        if( ae_fp_less(a->ptr.p_float[i],*threshold) )
        {
            if( c->ptr.p_int[i]==0 )
            {
                *pal = *pal+1;
     ...
     ae_state *_state)
{
    ...
    *threshold = a->ptr.p_float[n-1];
        ...
        if( ae_fp_less(cc,cbest) )
        {
            ...
            *cvrms = 0;
            for(i=0; i<=nc-1; i++)
            {
                ...
                {
                    w = cntbuf->ptr.p_int[i];
                    *cvrms = *cvrms+w*ae_sqr((float)1/(float)nc-1, _state);
                    *cvrms = *cvrms+(sl-w)*ae_sqr((float)1/(float)nc, _state);
                }
                if( sr>1 )
                {
                    w = cntbuf->ptr.p_int[nc+i];
                ...
                else
                {
                    w = cntbuf->ptr.p_int[nc+i];
                    *cvrms = *cvrms+w*ae_sqr((float)1/(float)nc-1, _state);
                    *cvrms = *cvrms+(sr-w)*ae_sqr((float)1/(float)nc, _state);
                }
            }
     ...
     */
    *threshold = 0.5*(a->ptr.p_float[tiesbuf->ptr.p_int[koptimal]]+a->ptr.p_float[tiesbuf->ptr.p_int[koptimal+1]]);
    if( ae_fp_less_eq(*threshold,a->ptr.p_float[tiesbuf->ptr.p_int[koptimal]]) )
    {
        *threshold = a->ptr.p_float[tiesbuf->ptr.p_int[koptimal+1]];
    }
}
     ...
     ae_state *_state)
{
    ...
    *info = 1;
    ...
    for(k=2; k<=kmax; k++)
    {
        ...
        while(j<=tiecount-1&&i<=k-1)
        {
             ...
             */
            if( ae_fp_less(ae_fabs(cursizes.ptr.p_int[i]+ties.ptr.p_int[j+1]-ties.ptr.p_int[j]-(float)n/(float)k, _state),ae_fabs(cursizes.ptr.p_int[i]-(float)n/(float)k, _state)) )
            {
                cursizes.ptr.p_int[i] = cursizes.ptr.p_int[i]+ties.ptr.p_int[j+1]-ties.ptr.p_int[j];
                j = j+1;
            }
    ...
    *ni = bestk;
    ...
    for(i=1; i<=bestk-1; i++)
    {
        thresholds->ptr.p_float[i-1] = 0.5*(a->ptr.p_float[j-1]+a->ptr.p_float[j]);
     ...
     ae_state *_state)
{
    ...
    *info = 1;
    ...
    for(j=0; j<=tiecount-1; j++)
    {
        ...
        cv.ptr.pp_float[0][j] = bdss_getcv(&cnt, nc, _state);
    }
    for(k=1; k<=kmax-1; k++)
    {
        for(j=0; j<=nc-1; j++)
        ...
        for(j=k; j<=tiecount-1; j++)
        {
            ...
            cv.ptr.pp_float[k][j] = cv.ptr.pp_float[k-1][j-1]+bdss_getcv(&cnt2, nc, _state);
            ...
            for(s=k+1; s<=j; s++)
            {
                 ...
                 * Calculate CVE
                 */
                cvtemp = cv.ptr.pp_float[k-1][s-1]+bdss_getcv(&cnt2, nc, _state);
                if( ae_fp_less(cvtemp,cv.ptr.pp_float[k][j]) )
                {
                    cv.ptr.pp_float[k][j] = cvtemp;
    ...
    for(k=0; k<=kmax-1; k++)
    {
        if( ae_fp_less(cv.ptr.pp_float[k][tiecount-1],cvoptimal) )
        {
            cvoptimal = cv.ptr.pp_float[k][tiecount-1];
            koptimal = k;
        }
    }
    ...
    if( koptimal==0 )
    {
        ...
        thresholds->ptr.p_float[0] = 0.5*(a->ptr.p_float[ties.ptr.p_int[j-1]]+a->ptr.p_float[ties.ptr.p_int[j]]);
        *ni = 2;
        *cve = 0;
        for(i=0; i<=nc-1; i++)
        {
    ...
    else
    {
        ...
        *ni = koptimal+1;
        *cve = cv.ptr.pp_float[koptimal][tiecount-1];
        jl = splits.ptr.pp_int[koptimal][tiecount-1];
        jr = tiecount-1;
        for(k=koptimal; k>=1; k--)
        {
            thresholds->ptr.p_float[k-1] = 0.5*(a->ptr.p_float[ties.ptr.p_int[jl-1]]+a->ptr.p_float[ties.ptr.p_int[jl]]);
            jr = jl-1;
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    if( nclasses>1 )
    {
        ...
        {
		//printf("i = %d\n", i);
		//printf("Outside if: Passing in value %f into ae_round\n", xy->ptr.pp_float[i][nvars]);
            if( ae_round(xy->ptr.pp_float[i][nvars], _state)<0||ae_round(xy->ptr.pp_float[i][nvars], _state)>=nclasses )
            {
		printf("Passing in value %f into ae_round.\n", xy->ptr.pp_float[i][nvars]);
		printf("Class %f\n", ae_round(xy->ptr.pp_float[i][nvars], _state));
		printf("The class it out of bounds.\n");
                *info = -2;
                ae_frame_leave(_state);
                return;
            }
    ...
    *info = 1;
    ...
    if( useevs )
    {
        for(j=0; j<=nvars-1; j++)
        {
            vmin = xy->ptr.pp_float[0][j];
            vmax = vmin;
            for(i=0; i<=npoints-1; i++)
            {
                v = xy->ptr.pp_float[i][j];
            ...
            else
            {
                ...
                bufs.evssplits.ptr.p_float[j] = 0.5*(vmin+vmax);
                if( ae_fp_less_eq(bufs.evssplits.ptr.p_float[j],vmin) )
                {
                    bufs.evssplits.ptr.p_float[j] = vmax;
                }
            }
        }
    }
    ...
    for(i=0; i<=ntrees-1; i++)
    {
        ...
        for(k=0; k<=samplesize-1; k++)
        {
            ...
            ae_v_move(&xys.ptr.pp_float[k][0], 1, &xy->ptr.pp_float[j][0], 1, ae_v_len(0,nvars));
        }
        ...
        j = ae_round(bufs.treebuf.ptr.p_float[0], _state);
        ae_v_move(&df->trees.ptr.p_float[offs], 1, &bufs.treebuf.ptr.p_float[0], 1, ae_v_len(offs,offs+j-1));
        lasttreeoffs = offs;
        offs = offs+j;
        ...
        for(k=samplesize; k<=npoints-1; k++)
        {
            ...
            j = permbuf.ptr.p_int[k];
            ae_v_move(&x.ptr.p_float[0], 1, &xy->ptr.pp_float[j][0], 1, ae_v_len(0,nvars-1));
            dforest_dfprocessinternal(df, lasttreeoffs, &x, &y, _state);
            ae_v_add(&oobbuf.ptr.p_float[j*nclasses], 1, &y.ptr.p_float[0], 1, ae_v_len(j*nclasses,(j+1)*nclasses-1));
    ...
    for(i=0; i<=npoints-1; i++)
    {
        ...
        {
            v = (float)1/(float)oobcntbuf.ptr.p_int[i];
            ae_v_muld(&oobbuf.ptr.p_float[i*nclasses], 1, ae_v_len(i*nclasses,i*nclasses+nclasses-1), v);
        }
    }
    ...
    for(i=0; i<=npoints-1; i++)
    {
        if( oobcntbuf.ptr.p_int[i]!=0 )
        {
            ...
            if( nclasses>1 )
            {
                 ...
                 */
                k = ae_round(xy->ptr.pp_float[i][nvars], _state);
                tmpi = 0;
                for(j=1; j<=nclasses-1; j++)
                {
                    if( ae_fp_greater(oobbuf.ptr.p_float[ooboffs+j],oobbuf.ptr.p_float[ooboffs+tmpi]) )
                    {
                        tmpi = j;
                    }
                }
                ...
                if( ae_fp_neq(oobbuf.ptr.p_float[ooboffs+k],0) )
                {
                    rep->oobavgce = rep->oobavgce-ae_log(oobbuf.ptr.p_float[ooboffs+k], _state);
                }
                else
                {
                ...
                for(j=0; j<=nclasses-1; j++)
                {
                    if( j==k )
                    {
                        rep->oobrmserror = rep->oobrmserror+ae_sqr(oobbuf.ptr.p_float[ooboffs+j]-1, _state);
                        rep->oobavgerror = rep->oobavgerror+ae_fabs(oobbuf.ptr.p_float[ooboffs+j]-1, _state);
                        rep->oobavgrelerror = rep->oobavgrelerror+ae_fabs(oobbuf.ptr.p_float[ooboffs+j]-1, _state);
                        oobrelcnt = oobrelcnt+1;
                    }
                    else
                    {
                        rep->oobrmserror = rep->oobrmserror+ae_sqr(oobbuf.ptr.p_float[ooboffs+j], _state);
                        rep->oobavgerror = rep->oobavgerror+ae_fabs(oobbuf.ptr.p_float[ooboffs+j], _state);
                    }
                }
            }
            else
            {
                 ...
                 */
                rep->oobrmserror = rep->oobrmserror+ae_sqr(oobbuf.ptr.p_float[ooboffs]-xy->ptr.pp_float[i][nvars], _state);
                rep->oobavgerror = rep->oobavgerror+ae_fabs(oobbuf.ptr.p_float[ooboffs]-xy->ptr.pp_float[i][nvars], _state);
                if( ae_fp_neq(xy->ptr.pp_float[i][nvars],0) )
                {
                    rep->oobavgrelerror = rep->oobavgrelerror+ae_fabs((oobbuf.ptr.p_float[ooboffs]-xy->ptr.pp_float[i][nvars])/xy->ptr.pp_float[i][nvars], _state);
                    oobrelcnt = oobrelcnt+1;
                }
            }
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=df->ntrees-1; i++)
    {
         ...
         * Next tree
         */
        offs = offs+ae_round(df->trees.ptr.p_float[offs], _state);
    }
    v = (float)1/(float)df->ntrees;
    ae_v_muld(&y->ptr.p_float[0], 1, ae_v_len(0,df->nclasses-1), v);
}
     ...
     ae_state *_state)
{
    ...
    result = (float)dforest_dfclserror(df, xy, npoints, _state)/(float)npoints;
    return result;
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=npoints-1; i++)
    {
        ae_v_move(&x.ptr.p_float[0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,df->nvars-1));
        dfprocess(df, &x, &y, _state);
        if( df->nclasses>1 )
        {
             ...
             * classification-specific code
             */
            k = ae_round(xy->ptr.pp_float[i][df->nvars], _state);
            tmpi = 0;
            for(j=1; j<=df->nclasses-1; j++)
            {
                if( ae_fp_greater(y.ptr.p_float[j],y.ptr.p_float[tmpi]) )
                {
                    tmpi = j;
                }
            }
            if( ae_fp_neq(y.ptr.p_float[k],0) )
            {
                result = result-ae_log(y.ptr.p_float[k], _state);
            }
            else
            {
    ...
    for(i=0; i<=npoints-1; i++)
    {
        ...
        if( df->nclasses>1 )
        {
            ...
            for(j=0; j<=df->nclasses-1; j++)
            {
                if( j==k )
                {
                    result = result+ae_sqr(y.ptr.p_float[j]-1, _state);
                }
                else
                {
                    result = result+ae_sqr(y.ptr.p_float[j], _state);
                }
            }
        }
        else
        {
             ...
             * regression-specific code
             */
            result = result+ae_sqr(y.ptr.p_float[0]-xy->ptr.pp_float[i][df->nvars], _state);
        }
    }
    ...
    for(i=0; i<=npoints-1; i++)
    {
        ...
        if( df->nclasses>1 )
        {
            ...
            for(j=0; j<=df->nclasses-1; j++)
            {
                if( j==k )
                {
                    result = result+ae_fabs(y.ptr.p_float[j]-1, _state);
                }
                else
                {
                    result = result+ae_fabs(y.ptr.p_float[j], _state);
                }
            }
        }
        else
        {
             ...
             * regression-specific code
             */
            result = result+ae_fabs(y.ptr.p_float[0]-xy->ptr.pp_float[i][df->nvars], _state);
        }
    }
     ...
     ae_state *_state)
{
	...
	if( df->nclasses>1 )
        ...
        else
        {
             ...
             * regression-specific code
             */
            if( ae_fp_neq(xy->ptr.pp_float[i][df->nvars],0) )
            {
                result = result+ae_fabs((y.ptr.p_float[0]-xy->ptr.pp_float[i][df->nvars])/xy->ptr.pp_float[i][df->nvars], _state);
                relcnt = relcnt+1;
            }
        }
    }
...
void dfcopy(decisionforest* df1, decisionforest* df2, ae_state *_state)
{
    ...
    ae_v_move(&df2->trees.ptr.p_float[0], 1, &df1->trees.ptr.p_float[0], 1, ae_v_len(0,df1->bufsize-1));
}
     ...
     ae_state *_state)
{
    ...
    for(;;)
    {
        if( ae_fp_eq(df->trees.ptr.p_float[k],-1) )
        {
            if( df->nclasses==1 )
            {
                y->ptr.p_float[0] = y->ptr.p_float[0]+df->trees.ptr.p_float[k+1];
            }
            else
            {
                idx = ae_round(df->trees.ptr.p_float[k+1], _state);
                y->ptr.p_float[idx] = y->ptr.p_float[idx]+1;
            }
            break;
        }
        if( ae_fp_less(x->ptr.p_float[ae_round(df->trees.ptr.p_float[k], _state)],df->trees.ptr.p_float[k+1]) )
        {
            k = k+dforest_innernodewidth;
        }
        else
        {
            k = offs+ae_round(df->trees.ptr.p_float[k+2], _state);
        }
    }
}
     ...
     ae_state *_state)
{
    ...
    bufs->treebuf.ptr.p_float[0] = numprocessed;
}
     ...
     ae_state *_state)
{
    ...
    if( idx2==idx1 )
    {
        bufs->treebuf.ptr.p_float[*numprocessed] = -1;
        bufs->treebuf.ptr.p_float[*numprocessed+1] = xy->ptr.pp_float[bufs->idxbuf.ptr.p_int[idx1]][nvars];
    ...
    if( nclasses>1 )
    {
        ...
        for(i=idx1; i<=idx2; i++)
        {
            j = ae_round(xy->ptr.pp_float[bufs->idxbuf.ptr.p_int[i]][nvars], _state);
    ...
    else
    {
        ...
        for(i=idx1; i<=idx2; i++)
        {
            v = v+xy->ptr.pp_float[bufs->idxbuf.ptr.p_int[i]][nvars];
        }
        v = v/(idx2-idx1+1);
        ebest = 0;
        for(i=idx1; i<=idx2; i++)
        {
            ebest = ebest+ae_sqr(xy->ptr.pp_float[bufs->idxbuf.ptr.p_int[i]][nvars]-v, _state);
        }
    ...
    while(i<=ae_minint(nfeatures, nvarsinpool, _state)-1)
    {
        ...
        for(j=idx1; j<=idx2; j++)
        {
            bufs->tmpbufr.ptr.p_float[j-idx1] = xy->ptr.pp_float[bufs->idxbuf.ptr.p_int[j]][varcur];
        }
        if( useevs )
        {
            bflag = ae_false;
            v = bufs->tmpbufr.ptr.p_float[0];
            for(j=0; j<=idx2-idx1; j++)
            {
                if( ae_fp_neq(bufs->tmpbufr.ptr.p_float[j],v) )
                {
                    bflag = ae_true;
                    break;
                }
        ...
        if( nclasses>1 )
        {
            for(j=idx1; j<=idx2; j++)
            {
                bufs->tmpbufi.ptr.p_int[j-idx1] = ae_round(xy->ptr.pp_float[bufs->idxbuf.ptr.p_int[j]][nvars], _state);
            }
        }
        else
        {
            for(j=idx1; j<=idx2; j++)
            {
                bufs->tmpbufr2.ptr.p_float[j-idx1] = xy->ptr.pp_float[bufs->idxbuf.ptr.p_int[j]][nvars];
            }
        }
        ...
        if( useevs&&bufs->evsbin.ptr.p_bool[varcur] )
        {
             ...
             */
            threshold = bufs->evssplits.ptr.p_float[varcur];
            if( nclasses>1 )
            {
                ...
                for(j=0; j<=idx2-idx1; j++)
                {
                    ...
                    if( ae_fp_less(bufs->tmpbufr.ptr.p_float[j],threshold) )
                    {
            ...
            else
            {
                ...
                for(j=0; j<=idx2-idx1; j++)
                {
                    if( ae_fp_less(bufs->tmpbufr.ptr.p_float[j],threshold) )
                    {
                        v1 = v1+bufs->tmpbufr2.ptr.p_float[j];
                        sl = sl+1;
                    }
                    else
                    {
                        v2 = v2+bufs->tmpbufr2.ptr.p_float[j];
                        sr = sr+1;
                    }
                }
                ae_assert(ae_fp_neq(sl,0)&&ae_fp_neq(sr,0), "DFBuildTreeRec: something strange!", _state);
                ...
                for(j=0; j<=idx2-idx1; j++)
                {
                    if( ae_fp_less(bufs->tmpbufr.ptr.p_float[j],threshold) )
                    {
                        currms = currms+ae_sqr(v1-bufs->tmpbufr2.ptr.p_float[j], _state);
                    }
                    else
                    {
                        currms = currms+ae_sqr(v2-bufs->tmpbufr2.ptr.p_float[j], _state);
                    }
                }
    ...
    if( idxbest<0 )
    {
        ...
        if( nclasses>1 )
        {
             ...
             */
            bufs->treebuf.ptr.p_float[*numprocessed+1] = ae_round(xy->ptr.pp_float[bufs->idxbuf.ptr.p_int[idx1+ae_randominteger(idx2-idx1+1, _state)]][nvars], _state);
        }
        else
        {
            ...
            for(i=idx1; i<=idx2; i++)
            {
                v = v+xy->ptr.pp_float[bufs->idxbuf.ptr.p_int[i]][nvars]/(idx2-idx1+1);
            }
            bufs->treebuf.ptr.p_float[*numprocessed+1] = v;
        }
        *numprocessed = *numprocessed+dforest_leafnodewidth;
    }
    else
    {
         ...
         * we can split
         */
        bufs->treebuf.ptr.p_float[*numprocessed] = idxbest;
        bufs->treebuf.ptr.p_float[*numprocessed+1] = tbest;
        i1 = idx1;
        i2 = idx2;
        while(i1<=i2)
        {
             ...
             */
            if( ae_fp_less(xy->ptr.pp_float[bufs->idxbuf.ptr.p_int[i1]][idxbest],tbest) )
            {
                i1 = i1+1;
                continue;
            }
            if( ae_fp_greater_eq(xy->ptr.pp_float[bufs->idxbuf.ptr.p_int[i2]][idxbest],tbest) )
            {
                i2 = i2-1;
                continue;
            }
        ...
        *numprocessed = *numprocessed+dforest_innernodewidth;
        ...
        bufs->treebuf.ptr.p_float[oldnp+2] = *numprocessed;
     ...
     ae_state *_state)
{
    ...
    *e = ae_maxrealnumber;
    *threshold = 0.5*(x->ptr.p_float[0]+x->ptr.p_float[n-1]);
    *info = -3;
    ...
    for(q=qmin; q<=qmax; q++)
    {
        cursplit = x->ptr.p_float[n*q/qcnt];
        neq = 0;
        nless = 0;
        ngreater = 0;
        for(i=0; i<=n-1; i++)
        {
            if( ae_fp_less(x->ptr.p_float[i],cursplit) )
            {
                nless = nless+1;
            }
            if( ae_fp_eq(x->ptr.p_float[i],cursplit) )
            {
                neq = neq+1;
            }
            if( ae_fp_greater(x->ptr.p_float[i],cursplit) )
            {
                ngreater = ngreater+1;
            }
        }
        ...
        if( nless!=0||ngreater!=0 )
        {
            ...
            if( nless<ngreater )
            {
                cursplit = 0.5*(x->ptr.p_float[nless+neq-1]+x->ptr.p_float[nless+neq]);
                nleft = nless+neq;
                if( ae_fp_less_eq(cursplit,x->ptr.p_float[nless+neq-1]) )
                {
                    cursplit = x->ptr.p_float[nless+neq];
                }
            }
            else
            {
                cursplit = 0.5*(x->ptr.p_float[nless-1]+x->ptr.p_float[nless]);
                nleft = nless;
                if( ae_fp_less_eq(cursplit,x->ptr.p_float[nless-1]) )
                {
                    cursplit = x->ptr.p_float[nless];
                }
            }
            *info = 1;
            cure = 0;
    ...
    for(q=qmin; q<=qmax; q++)
    {
        ...
        if( nless!=0||ngreater!=0 )
        {
            ...
            *info = 1;
            ...
            for(i=0; i<=nleft-1; i++)
            {
                cure = cure+ae_sqr(y->ptr.p_float[i]-v, _state);
            }
            v = 0;
            for(i=nleft; i<=n-1; i++)
            {
     ...
     ae_state *_state)
{
    ...
    *info = 1;
    ...
    for(pass=1; pass<=restarts; pass++)
    {
        ...
        ae_v_move(&ct.ptr.pp_float[0][0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1));
        ...
        for(;;)
        {
            ...
            for(i=0; i<=npoints-1; i++)
            {
                ...
                for(j=0; j<=k-1; j++)
                {
                    ae_v_move(&tmp.ptr.p_float[0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1));
                    ae_v_sub(&tmp.ptr.p_float[0], 1, &ct.ptr.pp_float[j][0], 1, ae_v_len(0,nvars-1));
                    v = ae_v_dotproduct(&tmp.ptr.p_float[0], 1, &tmp.ptr.p_float[0], 1, ae_v_len(0,nvars-1));
            ...
            for(i=0; i<=k-1; i++)
            {
                for(j=0; j<=nvars-1; j++)
                {
                    ct.ptr.pp_float[i][j] = 0;
                }
            }
            for(i=0; i<=npoints-1; i++)
            {
                csizes.ptr.p_int[xyc->ptr.p_int[i]] = csizes.ptr.p_int[xyc->ptr.p_int[i]]+1;
                ae_v_add(&ct.ptr.pp_float[xyc->ptr.p_int[i]][0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1));
            }
            ...
            for(j=0; j<=k-1; j++)
            {
                v = (float)1/(float)csizes.ptr.p_int[j];
                ae_v_muld(&ct.ptr.pp_float[j][0], 1, ae_v_len(0,nvars-1), v);
            }
        ...
        {
            ae_v_move(&tmp.ptr.p_float[0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1));
            ae_v_sub(&tmp.ptr.p_float[0], 1, &ct.ptr.pp_float[xyc->ptr.p_int[i]][0], 1, ae_v_len(0,nvars-1));
            v = ae_v_dotproduct(&tmp.ptr.p_float[0], 1, &tmp.ptr.p_float[0], 1, ae_v_len(0,nvars-1));
            e = e+v;
        }
     ...
     ae_state *_state)
{
    ...
    for(cc=0; cc<=ccnt-1; cc++)
    {
        if( !busycenters->ptr.p_bool[cc] )
        {
            ...
            for(i=0; i<=npoints-1; i++)
            {
                d2->ptr.p_float[i] = ae_maxrealnumber;
                for(j=0; j<=ccnt-1; j++)
                {
                    if( busycenters->ptr.p_bool[j] )
                    {
                        ae_v_move(&tmp->ptr.p_float[0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1));
                        ae_v_sub(&tmp->ptr.p_float[0], 1, &centers->ptr.pp_float[j][0], 1, ae_v_len(0,nvars-1));
                        v = ae_v_dotproduct(&tmp->ptr.p_float[0], 1, &tmp->ptr.p_float[0], 1, ae_v_len(0,nvars-1));
                        if( ae_fp_less(v,d2->ptr.p_float[i]) )
                        {
                            d2->ptr.p_float[i] = v;
                        }
                    }
            ...
            s = 1/s;
            ae_v_moved(&p->ptr.p_float[0], 1, &d2->ptr.p_float[0], 1, ae_v_len(0,npoints-1), s);
            ...
            for(i=0; i<=npoints-1; i++)
            {
                ...
                {
                    ae_v_move(&centers->ptr.pp_float[cc][0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1));
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    if( *info>0 )
    {
        ...
        ae_v_move(&w->ptr.p_float[0], 1, &w2.ptr.pp_float[0][0], w2.stride, ae_v_len(0,nvars-1));
    }
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    *info = 1;
        ...
        *info = 2;
        ...
        for(i=0; i<=nvars-1; i++)
        {
            for(j=0; j<=nvars-1; j++)
            {
                if( i==j )
                {
                    w->ptr.pp_float[i][j] = 1;
                }
                else
                {
                    w->ptr.pp_float[i][j] = 0;
                }
            }
        }
        ae_frame_leave(_state);
    ...
    for(i=0; i<=npoints-1; i++)
    {
        c.ptr.p_int[i] = ae_round(xy->ptr.pp_float[i][nvars], _state);
    }
    ...
    for(i=0; i<=nclasses-1; i++)
    {
        ...
        for(j=0; j<=nvars-1; j++)
        {
            muc.ptr.pp_float[i][j] = 0;
        }
    }
    for(i=0; i<=npoints-1; i++)
    {
        ae_v_add(&mu.ptr.p_float[0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1));
        ae_v_add(&muc.ptr.pp_float[c.ptr.p_int[i]][0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1));
        nc.ptr.p_int[c.ptr.p_int[i]] = nc.ptr.p_int[c.ptr.p_int[i]]+1;
    }
    for(i=0; i<=nclasses-1; i++)
    {
        v = (float)1/(float)nc.ptr.p_int[i];
        ae_v_muld(&muc.ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1), v);
    }
    v = (float)1/(float)npoints;
    ae_v_muld(&mu.ptr.p_float[0], 1, ae_v_len(0,nvars-1), v);
    ...
    for(i=0; i<=nvars-1; i++)
    {
        for(j=0; j<=nvars-1; j++)
        {
            st.ptr.pp_float[i][j] = 0;
        }
    }
    for(k=0; k<=npoints-1; k++)
    {
        ae_v_move(&tf.ptr.p_float[0], 1, &xy->ptr.pp_float[k][0], 1, ae_v_len(0,nvars-1));
        ae_v_sub(&tf.ptr.p_float[0], 1, &mu.ptr.p_float[0], 1, ae_v_len(0,nvars-1));
        for(i=0; i<=nvars-1; i++)
        {
            v = tf.ptr.p_float[i];
            ae_v_addd(&st.ptr.pp_float[i][0], 1, &tf.ptr.p_float[0], 1, ae_v_len(0,nvars-1), v);
        }
    }
    ...
    for(i=0; i<=nvars-1; i++)
    {
        for(j=0; j<=nvars-1; j++)
        {
            sw.ptr.pp_float[i][j] = 0;
        }
    }
    for(k=0; k<=npoints-1; k++)
    {
        ae_v_move(&tf.ptr.p_float[0], 1, &xy->ptr.pp_float[k][0], 1, ae_v_len(0,nvars-1));
        ae_v_sub(&tf.ptr.p_float[0], 1, &muc.ptr.pp_float[c.ptr.p_int[k]][0], 1, ae_v_len(0,nvars-1));
        for(i=0; i<=nvars-1; i++)
        {
            v = tf.ptr.p_float[i];
            ae_v_addd(&sw.ptr.pp_float[i][0], 1, &tf.ptr.p_float[0], 1, ae_v_len(0,nvars-1), v);
        }
    }
    ...
    ae_matrix_set_length(w, nvars-1+1, nvars-1+1, _state);
    if( ae_fp_less_eq(d.ptr.p_float[nvars-1],0)||ae_fp_less_eq(d.ptr.p_float[0],1000*ae_machineepsilon*d.ptr.p_float[nvars-1]) )
    {
         ...
         */
        if( ae_fp_less_eq(d.ptr.p_float[nvars-1],0) )
        {
            *info = 2;
            for(i=0; i<=nvars-1; i++)
            {
        ...
        for(k=0; k<=nvars-1; k++)
        {
            if( ae_fp_less_eq(d.ptr.p_float[k],1000*ae_machineepsilon*d.ptr.p_float[nvars-1]) )
            {
                m = k+1;
            }
        }
        ...
        for(i=0; i<=npoints-1; i++)
        {
            xyproj.ptr.pp_float[i][nvars-m] = xy->ptr.pp_float[i][nvars];
        }
        ...
        {
            ae_v_move(&w->ptr.pp_float[0][k], w->stride, &z.ptr.pp_float[0][k-(nvars-m)], z.stride, ae_v_len(0,nvars-1));
        }
        *info = 2;
    }
    else
    {
        ...
        for(i=0; i<=nvars-1; i++)
        {
            for(j=0; j<=nvars-1; j++)
            {
                a.ptr.pp_float[i][j] = a.ptr.pp_float[i][j]/ae_sqrt(d.ptr.p_float[i]*d.ptr.p_float[j], _state);
            }
        }
        ...
        for(k=0; k<=nvars-1; k++)
        {
            for(i=0; i<=nvars-1; i++)
            {
                tf.ptr.p_float[i] = z2.ptr.pp_float[i][k]/ae_sqrt(d.ptr.p_float[i], _state);
            }
            for(i=0; i<=nvars-1; i++)
            {
                v = ae_v_dotproduct(&z.ptr.pp_float[i][0], 1, &tf.ptr.p_float[0], 1, ae_v_len(0,nvars-1));
                w->ptr.pp_float[i][k] = v;
            }
        }
    }
    ...
    for(k=0; k<=nvars-1; k++)
    {
        v = ae_v_dotproduct(&w->ptr.pp_float[0][k], w->stride, &w->ptr.pp_float[0][k], w->stride, ae_v_len(0,nvars-1));
        v = 1/ae_sqrt(v, _state);
        ae_v_muld(&w->ptr.pp_float[0][k], w->stride, ae_v_len(0,nvars-1), v);
        v = 0;
        for(i=0; i<=nvars-1; i++)
        {
            v = v+w->ptr.pp_float[i][k];
        }
        if( ae_fp_less(v,0) )
        {
            ae_v_muld(&w->ptr.pp_float[0][k], w->stride, ae_v_len(0,nvars-1), -1);
        }
    }
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    for(i=0; i<=nvars; i++)
    {
        ae_v_muld(&ar->c.ptr.pp_float[i][0], 1, ae_v_len(0,nvars), sigma2);
    }
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    for(i=0; i<=npoints-1; i++)
    {
        ae_v_move(&xyi.ptr.pp_float[i][0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1));
        xyi.ptr.pp_float[i][nvars] = 1;
        xyi.ptr.pp_float[i][nvars+1] = xy->ptr.pp_float[i][nvars];
    }
    ...
    for(j=0; j<=nvars-1; j++)
    {
        ae_v_move(&x.ptr.p_float[0], 1, &xy->ptr.pp_float[0][j], xy->stride, ae_v_len(0,npoints-1));
        ...
        for(i=0; i<=npoints-1; i++)
        {
            xyi.ptr.pp_float[i][j] = (xyi.ptr.pp_float[i][j]-means.ptr.p_float[j])/sigmas.ptr.p_float[j];
        }
    }
     ...
     * Un-standartization
     */
    offs = ae_round(lm->w.ptr.p_float[3], _state);
    for(j=0; j<=nvars-1; j++)
    {
         ...
         */
        lm->w.ptr.p_float[offs+nvars] = lm->w.ptr.p_float[offs+nvars]-lm->w.ptr.p_float[offs+j]*means.ptr.p_float[j]/sigmas.ptr.p_float[j];
        v = means.ptr.p_float[j]/sigmas.ptr.p_float[j];
        ae_v_subd(&ar->c.ptr.pp_float[nvars][0], 1, &ar->c.ptr.pp_float[j][0], 1, ae_v_len(0,nvars), v);
        ae_v_subd(&ar->c.ptr.pp_float[0][nvars], ar->c.stride, &ar->c.ptr.pp_float[0][j], ar->c.stride, ae_v_len(0,nvars), v);
        
        /*
         * J-th term is updated
         */
        lm->w.ptr.p_float[offs+j] = lm->w.ptr.p_float[offs+j]/sigmas.ptr.p_float[j];
        v = 1/sigmas.ptr.p_float[j];
        ae_v_muld(&ar->c.ptr.pp_float[j][0], 1, ae_v_len(0,nvars), v);
        ae_v_muld(&ar->c.ptr.pp_float[0][j], ar->c.stride, ae_v_len(0,nvars), v);
    }
    ae_frame_leave(_state);
}
    ...
    *info = 0;
    ...
    for(j=0; j<=nvars-1; j++)
    {
        ...
        else
        {
            ...
            c.ptr.p_float[j] = ae_sqrt(variance, _state);
        }
        for(i=0; i<=npoints-1; i++)
        {
            xyi.ptr.pp_float[i][j] = xyi.ptr.pp_float[i][j]/c.ptr.p_float[j];
        }
    }
    ...
    for(j=0; j<=nvars-1; j++)
    {
         ...
         * J-th term is updated
         */
        lm->w.ptr.p_float[offs+j] = lm->w.ptr.p_float[offs+j]/c.ptr.p_float[j];
        v = 1/c.ptr.p_float[j];
        ae_v_muld(&ar->c.ptr.pp_float[j][0], 1, ae_v_len(0,nvars), v);
        ae_v_muld(&ar->c.ptr.pp_float[0][j], ar->c.stride, ae_v_len(0,nvars), v);
    }
     ...
     ae_state *_state)
{
    ...
    *nvars = 0;
    ...
    ae_assert(ae_round(lm->w.ptr.p_float[1], _state)==linreg_lrvnum, "LINREG: Incorrect LINREG version!", _state);
    *nvars = ae_round(lm->w.ptr.p_float[2], _state);
    offs = ae_round(lm->w.ptr.p_float[3], _state);
    ae_vector_set_length(v, *nvars+1, _state);
    ae_v_move(&v->ptr.p_float[0], 1, &lm->w.ptr.p_float[offs], 1, ae_v_len(0,*nvars));
}
     ...
     ae_state *_state)
{
    ...
    offs = 4;
    lm->w.ptr.p_float[0] = 4+nvars+1;
    lm->w.ptr.p_float[1] = linreg_lrvnum;
    lm->w.ptr.p_float[2] = nvars;
    lm->w.ptr.p_float[3] = offs;
    ae_v_move(&lm->w.ptr.p_float[offs], 1, &v->ptr.p_float[0], 1, ae_v_len(offs,offs+nvars));
}
     ...
     ae_state *_state)
{
    ...
    nvars = ae_round(lm->w.ptr.p_float[2], _state);
    offs = ae_round(lm->w.ptr.p_float[3], _state);
    v = ae_v_dotproduct(&x->ptr.p_float[0], 1, &lm->w.ptr.p_float[offs], 1, ae_v_len(0,nvars-1));
    result = v+lm->w.ptr.p_float[offs+nvars];
    return result;
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=npoints-1; i++)
    {
        v = ae_v_dotproduct(&xy->ptr.pp_float[i][0], 1, &lm->w.ptr.p_float[offs], 1, ae_v_len(0,nvars-1));
        v = v+lm->w.ptr.p_float[offs+nvars];
        result = result+ae_sqr(v-xy->ptr.pp_float[i][nvars], _state);
    }
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=npoints-1; i++)
    {
        v = ae_v_dotproduct(&xy->ptr.pp_float[i][0], 1, &lm->w.ptr.p_float[offs], 1, ae_v_len(0,nvars-1));
        v = v+lm->w.ptr.p_float[offs+nvars];
        result = result+ae_fabs(v-xy->ptr.pp_float[i][nvars], _state);
    }
    result = result/npoints;
    return result;
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=npoints-1; i++)
    {
        if( ae_fp_neq(xy->ptr.pp_float[i][nvars],0) )
        {
            v = ae_v_dotproduct(&xy->ptr.pp_float[i][0], 1, &lm->w.ptr.p_float[offs], 1, ae_v_len(0,nvars-1));
            v = v+lm->w.ptr.p_float[offs+nvars];
            result = result+ae_fabs((v-xy->ptr.pp_float[i][nvars])/xy->ptr.pp_float[i][nvars], _state);
            k = k+1;
        }
    }
    if( k!=0 )
...
void lrcopy(linearmodel* lm1, linearmodel* lm2, ae_state *_state)
{
    ...
    k = ae_round(lm1->w.ptr.p_float[0], _state);
    ae_vector_set_length(&lm2->w, k-1+1, _state);
    ae_v_move(&lm2->w.ptr.p_float[0], 1, &lm1->w.ptr.p_float[0], 1, ae_v_len(0,k-1));
}
     ...
     ae_state *_state)
{
    ...
    *p = 0;
    ...
    for(i=0; i<=n-1; i++)
    {
        if( ae_fp_less_eq(s->ptr.p_float[i],0) )
        {
            *info = -2;
            return;
        }
    ...
    *info = 1;
    ...
    for(i=0; i<=n-1; i++)
    {
        t = ae_sqr(s->ptr.p_float[i], _state);
        ss = ss+1/t;
        sx = sx+xy->ptr.pp_float[i][0]/t;
        sy = sy+xy->ptr.pp_float[i][1]/t;
        sxx = sxx+ae_sqr(xy->ptr.pp_float[i][0], _state)/t;
    }
    ...
    *b = 0;
    ...
    for(i=0; i<=n-1; i++)
    {
        t = (xy->ptr.pp_float[i][0]-sx/ss)/s->ptr.p_float[i];
        *b = *b+t*xy->ptr.pp_float[i][1]/s->ptr.p_float[i];
    ...
    *a = (sy-sx*(*b))/ss;
    ...
    if( n>2 )
    {
        ...
        for(i=0; i<=n-1; i++)
        {
            chi2 = chi2+ae_sqr((xy->ptr.pp_float[i][1]-(*a)-*b*xy->ptr.pp_float[i][0])/s->ptr.p_float[i], _state);
        }
        *p = incompletegammac((float)(n-2)/(float)2, chi2/2, _state);
    }
    else
    {
        *p = 1;
     ...
     ae_state *_state)
{
    ...
    *info = 1;
    ...
    {
        r = 1/s->ptr.p_float[i];
        ae_v_moved(&a.ptr.pp_float[i][0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1), r);
        b.ptr.p_float[i] = xy->ptr.pp_float[i][nvars]/s->ptr.p_float[i];
    }
    ...
    offs = 4;
    lm->w.ptr.p_float[0] = 4+nvars;
    lm->w.ptr.p_float[1] = linreg_lrvnum;
    lm->w.ptr.p_float[2] = nvars-1;
    lm->w.ptr.p_float[3] = offs;
    ...
    if( ae_fp_less_eq(sv.ptr.p_float[0],0) )
    {
        ...
        for(i=0; i<=nvars-1; i++)
        {
            for(j=0; j<=nvars-1; j++)
            {
                ar->c.ptr.pp_float[i][j] = 0;
            }
        }
        ae_frame_leave(_state);
        return;
    }
    if( ae_fp_less_eq(sv.ptr.p_float[nvars-1],epstol*ae_machineepsilon*sv.ptr.p_float[0]) )
    {
        ...
        for(k=nvars; k>=1; k--)
        {
            if( ae_fp_greater(sv.ptr.p_float[k-1],epstol*ae_machineepsilon*sv.ptr.p_float[0]) )
            {
                ...
                for(i=0; i<=npoints-1; i++)
                {
                    for(j=0; j<=k-1; j++)
                    {
                        r = ae_v_dotproduct(&xy->ptr.pp_float[i][0], 1, &vt.ptr.pp_float[j][0], 1, ae_v_len(0,nvars-1));
                        xym.ptr.pp_float[i][j] = r;
                    }
                    xym.ptr.pp_float[i][k] = xy->ptr.pp_float[i][nvars];
                }
                ...
                for(j=0; j<=nvars-1; j++)
                {
                    lm->w.ptr.p_float[offs+j] = 0;
                }
                for(j=0; j<=k-1; j++)
                {
                    r = tlm.w.ptr.p_float[offs+j];
                    ae_v_addd(&lm->w.ptr.p_float[offs], 1, &vt.ptr.pp_float[j][0], 1, ae_v_len(offs,offs+nvars-1), r);
                }
    ...
    for(i=0; i<=nvars-1; i++)
    {
        if( ae_fp_greater(sv.ptr.p_float[i],epstol*ae_machineepsilon*sv.ptr.p_float[0]) )
        {
            svi.ptr.p_float[i] = 1/sv.ptr.p_float[i];
        }
        else
        {
            svi.ptr.p_float[i] = 0;
    ...
    {
        r = b.ptr.p_float[i];
        ae_v_addd(&t.ptr.p_float[0], 1, &u.ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1), r);
    }
    for(i=0; i<=nvars-1; i++)
    {
        lm->w.ptr.p_float[offs+i] = 0;
    }
    for(i=0; i<=nvars-1; i++)
    {
        r = t.ptr.p_float[i]*svi.ptr.p_float[i];
        ae_v_addd(&lm->w.ptr.p_float[offs], 1, &vt.ptr.pp_float[i][0], 1, ae_v_len(offs,offs+nvars-1), r);
    }
    for(j=0; j<=nvars-1; j++)
    {
        r = svi.ptr.p_float[j];
        ae_v_moved(&vm.ptr.pp_float[0][j], vm.stride, &vt.ptr.pp_float[j][0], 1, ae_v_len(0,nvars-1), r);
    }
    for(i=0; i<=nvars-1; i++)
    {
        for(j=i; j<=nvars-1; j++)
        {
            r = ae_v_dotproduct(&vm.ptr.pp_float[i][0], 1, &vm.ptr.pp_float[j][0], 1, ae_v_len(0,nvars-1));
            ar->c.ptr.pp_float[i][j] = r;
            ar->c.ptr.pp_float[j][i] = r;
        }
    }
    ...
    for(i=0; i<=npoints-1; i++)
    {
         ...
         */
        r = ae_v_dotproduct(&xy->ptr.pp_float[i][0], 1, &lm->w.ptr.p_float[offs], 1, ae_v_len(0,nvars-1));
        ar->rmserror = ar->rmserror+ae_sqr(r-xy->ptr.pp_float[i][nvars], _state);
        ar->avgerror = ar->avgerror+ae_fabs(r-xy->ptr.pp_float[i][nvars], _state);
        if( ae_fp_neq(xy->ptr.pp_float[i][nvars],0) )
        {
            ar->avgrelerror = ar->avgrelerror+ae_fabs((r-xy->ptr.pp_float[i][nvars])/xy->ptr.pp_float[i][nvars], _state);
            na = na+1;
        }
         ...
         */
        p = ae_v_dotproduct(&u.ptr.pp_float[i][0], 1, &u.ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1));
        ...
        r = s->ptr.p_float[i]*(r/s->ptr.p_float[i]-b.ptr.p_float[i]*p)/(1-p);
        ar->cvrmserror = ar->cvrmserror+ae_sqr(r-xy->ptr.pp_float[i][nvars], _state);
        ar->cvavgerror = ar->cvavgerror+ae_fabs(r-xy->ptr.pp_float[i][nvars], _state);
        if( ae_fp_neq(xy->ptr.pp_float[i][nvars],0) )
        {
            ar->cvavgrelerror = ar->cvavgrelerror+ae_fabs((r-xy->ptr.pp_float[i][nvars])/xy->ptr.pp_float[i][nvars], _state);
            nacv = nacv+1;
        }
        ncv = ncv+1;
    }
     ...
     ae_state *_state)
{
    ...
    {
        network->columnmeans.ptr.p_float[i] = b;
        network->columnsigmas.ptr.p_float[i] = d;
    }
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    for(i=nin; i<=nin+nout-1; i++)
    {
        network->columnmeans.ptr.p_float[i] = 0.5*(a+b);
        network->columnsigmas.ptr.p_float[i] = 0.5*(a-b);
    }
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    *rlen = 3+ssize+wcount+2*sigmalen;
    ...
    ra->ptr.p_float[0] = *rlen;
    ra->ptr.p_float[1] = mlpbase_mlpvnum;
    ra->ptr.p_float[2] = ssize;
    offs = 3;
    for(i=0; i<=ssize-1; i++)
    {
        ra->ptr.p_float[offs+i] = network->structinfo.ptr.p_int[i];
    }
    offs = offs+ssize;
    ae_v_move(&ra->ptr.p_float[offs], 1, &network->weights.ptr.p_float[0], 1, ae_v_len(offs,offs+wcount-1));
    offs = offs+wcount;
    ae_v_move(&ra->ptr.p_float[offs], 1, &network->columnmeans.ptr.p_float[0], 1, ae_v_len(offs,offs+sigmalen-1));
    offs = offs+sigmalen;
    ae_v_move(&ra->ptr.p_float[offs], 1, &network->columnsigmas.ptr.p_float[0], 1, ae_v_len(offs,offs+sigmalen-1));
    offs = offs+sigmalen;
}
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_round(ra->ptr.p_float[1], _state)==mlpbase_mlpvnum, "MLPUnserialize: incorrect array!", _state);
    
    /*
     * Unload StructInfo from IA
     */
    offs = 3;
    ssize = ae_round(ra->ptr.p_float[2], _state);
    ae_vector_set_length(&network->structinfo, ssize-1+1, _state);
    for(i=0; i<=ssize-1; i++)
    {
        network->structinfo.ptr.p_int[i] = ae_round(ra->ptr.p_float[offs+i], _state);
    }
    offs = offs+ssize;
     ...
     */
    ae_v_move(&network->weights.ptr.p_float[0], 1, &ra->ptr.p_float[offs], 1, ae_v_len(0,wcount-1));
    offs = offs+wcount;
    ae_v_move(&network->columnmeans.ptr.p_float[0], 1, &ra->ptr.p_float[offs], 1, ae_v_len(0,sigmalen-1));
    offs = offs+sigmalen;
    ae_v_move(&network->columnsigmas.ptr.p_float[0], 1, &ra->ptr.p_float[offs], 1, ae_v_len(0,sigmalen-1));
    offs = offs+sigmalen;
}
...
void mlprandomize(multilayerperceptron* network, ae_state *_state)
{
    ...
    {
        network->weights.ptr.p_float[i] = ae_randomreal(_state)-0.5;
    }
}
...
void mlprandomizefull(multilayerperceptron* network, ae_state *_state)
{
    ...
    for(i=0; i<=nin-1; i++)
    {
        network->columnmeans.ptr.p_float[i] = 2*ae_randomreal(_state)-1;
        network->columnsigmas.ptr.p_float[i] = 1.5*ae_randomreal(_state)+0.5;
    }
    if( !mlpissoftmax(network, _state) )
    {
        for(i=0; i<=nout-1; i++)
        {
            ...
            if( ntype==0 )
            {
                 ...
                 */
                network->columnmeans.ptr.p_float[nin+i] = 2*ae_randomreal(_state)-1;
            }
            if( ntype==0||ntype==3 )
            {
                 ...
                 */
                network->columnsigmas.ptr.p_float[nin+i] = ae_sign(network->columnsigmas.ptr.p_float[nin+i], _state)*(1.5*ae_randomreal(_state)+0.5);
            }
        }
    }
}
     ...
     ae_state *_state)
{
    ...
    for(j=0; j<=jmax; j++)
    {
        means.ptr.p_float[j] = 0;
        for(i=0; i<=ssize-1; i++)
        {
            means.ptr.p_float[j] = means.ptr.p_float[j]+xy->ptr.pp_float[i][j];
        }
        means.ptr.p_float[j] = means.ptr.p_float[j]/ssize;
        sigmas.ptr.p_float[j] = 0;
        for(i=0; i<=ssize-1; i++)
        {
            sigmas.ptr.p_float[j] = sigmas.ptr.p_float[j]+ae_sqr(xy->ptr.pp_float[i][j]-means.ptr.p_float[j], _state);
        }
        sigmas.ptr.p_float[j] = ae_sqrt(sigmas.ptr.p_float[j]/ssize, _state);
    }
    ...
    for(i=0; i<=nin-1; i++)
    {
        network->columnmeans.ptr.p_float[i] = means.ptr.p_float[i];
        network->columnsigmas.ptr.p_float[i] = sigmas.ptr.p_float[i];
        if( ae_fp_eq(network->columnsigmas.ptr.p_float[i],0) )
        {
            network->columnsigmas.ptr.p_float[i] = 1;
        }
    }
    ...
    if( !mlpissoftmax(network, _state) )
    {
        for(i=0; i<=nout-1; i++)
        {
            ...
            if( ntype==0 )
            {
                network->columnmeans.ptr.p_float[nin+i] = means.ptr.p_float[nin+i];
                network->columnsigmas.ptr.p_float[nin+i] = sigmas.ptr.p_float[nin+i];
                if( ae_fp_eq(network->columnsigmas.ptr.p_float[nin+i],0) )
                {
                    network->columnsigmas.ptr.p_float[nin+i] = 1;
                }
            }
            ...
            if( ntype==3 )
            {
                s = means.ptr.p_float[nin+i]-network->columnmeans.ptr.p_float[nin+i];
                if( ae_fp_eq(s,0) )
                {
                    s = ae_sign(network->columnsigmas.ptr.p_float[nin+i], _state);
                }
                if( ae_fp_eq(s,0) )
                {
                    s = 1.0;
                }
                network->columnsigmas.ptr.p_float[nin+i] = ae_sign(network->columnsigmas.ptr.p_float[nin+i], _state)*ae_fabs(s, _state);
                if( ae_fp_eq(network->columnsigmas.ptr.p_float[nin+i],0) )
                {
                    network->columnsigmas.ptr.p_float[nin+i] = 1;
                }
     ...
     ae_state *_state)
{
    ...
    *mean = network->columnmeans.ptr.p_float[i];
    *sigma = network->columnsigmas.ptr.p_float[i];
    if( ae_fp_eq(*sigma,0) )
    {
        *sigma = 1;
    }
     ...
     ae_state *_state)
{
    ...
    *sigma = 0;
    ...
    {
        *mean = network->columnmeans.ptr.p_float[network->hllayersizes.ptr.p_int[0]+i];
        *sigma = network->columnsigmas.ptr.p_float[network->hllayersizes.ptr.p_int[0]+i];
    }
}
     ...
     ae_state *_state)
{
    ...
    *threshold = 0;
    ...
    {
        *threshold = network->weights.ptr.p_float[network->hlneurons.ptr.p_int[highlevelidx*mlpbase_hlnfieldwidth+3]];
    }
    else
    {
        *threshold = 0;
     ...
     ae_state *_state)
{
    ...
    if( highlevelidx>=0 )
    {
        result = network->weights.ptr.p_float[network->hlconnections.ptr.p_int[highlevelidx*mlpbase_hlconnfieldwidth+4]];
    }
    else
    {
        result = 0;
     ...
     ae_state *_state)
{
    ...
    network->columnmeans.ptr.p_float[i] = mean;
    network->columnsigmas.ptr.p_float[i] = sigma;
}
     ...
     ae_state *_state)
{
    ...
    else
    {
        ...
        network->columnmeans.ptr.p_float[network->hllayersizes.ptr.p_int[0]+i] = mean;
        network->columnsigmas.ptr.p_float[network->hllayersizes.ptr.p_int[0]+i] = sigma;
    }
}
     ...
     ae_state *_state)
{
    ...
    if( network->hlneurons.ptr.p_int[highlevelidx*mlpbase_hlnfieldwidth+3]>=0 )
    {
        network->weights.ptr.p_float[network->hlneurons.ptr.p_int[highlevelidx*mlpbase_hlnfieldwidth+3]] = threshold;
    }
    else
    {
     ...
     ae_state *_state)
{
    ...
    if( highlevelidx>=0 )
    {
        network->weights.ptr.p_float[network->hlconnections.ptr.p_int[highlevelidx*mlpbase_hlconnfieldwidth+4]] = w;
    }
    else
    {
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=ssize-1; i++)
    {
        ae_v_move(&network->x.ptr.p_float[0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nin-1));
        ...
        if( mlpissoftmax(network, _state) )
        {
             ...
             */
            k = ae_round(xy->ptr.pp_float[i][nin], _state);
            if( k>=0&&k<nout )
            {
                network->y.ptr.p_float[k] = network->y.ptr.p_float[k]-1;
            }
        }
        else
        {
             ...
             * real outputs
             */
            ae_v_sub(&network->y.ptr.p_float[0], 1, &xy->ptr.pp_float[i][nin], 1, ae_v_len(0,nout-1));
        }
        e = ae_v_dotproduct(&network->y.ptr.p_float[0], 1, &network->y.ptr.p_float[0], 1, ae_v_len(0,nout-1));
        result = result+e/2;
    }
    return result;
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=ssize-1; i++)
    {
        ...
        else
        {
            ...
            if( k>=0&&k<nout )
            {
                result = result+mlpbase_safecrossentropy(1, network->y.ptr.p_float[k], _state);
            }
        }
    }
    return result;
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=ssize-1; i++)
    {
         ...
         * Process
         */
        ae_v_move(&workx.ptr.p_float[0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nin-1));
        ...
        for(j=0; j<=nout-1; j++)
        {
            if( ae_fp_greater(worky.ptr.p_float[j],worky.ptr.p_float[nmax]) )
            {
                nmax = j;
            }
        }
        ...
        if( mlpissoftmax(network, _state) )
        {
            ns = ae_round(xy->ptr.pp_float[i][nin], _state);
        }
        else
        {
            nmax = 0;
            for(j=0; j<=nout-1; j++)
            {
                if( ae_fp_greater(xy->ptr.pp_float[i][nin+j],xy->ptr.pp_float[i][nin+nmax]) )
                {
                    nmax = j;
                }
            }
     ...
     ae_state *_state)
{
    ...
    result = (float)mlpclserror(network, xy, npoints, _state)/(float)npoints;
    return result;
}
    ...
    for(i=0; i<=npoints-1; i++)
    {
        ...
        if( mlpissoftmax(network, _state) )
        {
            ...
            for(j=0; j<=nout-1; j++)
            {
                if( j==k )
                {
                    result = result+ae_fabs(1-network->y.ptr.p_float[j], _state);
                }
                else
                {
                    result = result+ae_fabs(network->y.ptr.p_float[j], _state);
                }
            }
        }
        else
        {
            ...
            for(j=0; j<=nout-1; j++)
            {
                result = result+ae_fabs(xy->ptr.pp_float[i][nin+j]-network->y.ptr.p_float[j], _state);
            }
        }
    }
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=npoints-1; i++)
    {
        ...
        if( mlpissoftmax(network, _state) )
        {
             ...
             * class labels
             */
            lk = ae_round(xy->ptr.pp_float[i][nin], _state);
            for(j=0; j<=nout-1; j++)
            {
                if( j==lk )
                {
        ...
        else
        {
            ...
            for(j=0; j<=nout-1; j++)
            {
                if( ae_fp_neq(xy->ptr.pp_float[i][nin+j],0) )
                {
                    result = result+ae_fabs(xy->ptr.pp_float[i][nin+j]-network->y.ptr.p_float[j], _state)/ae_fabs(xy->ptr.pp_float[i][nin+j], _state);
                    k = k+1;
                }
            }
        }
     ...
     ae_state *_state)
{
    ...
    *e = 0;
    ...
    {
        network->derror.ptr.p_float[i] = 0;
    }
    for(i=0; i<=nout-1; i++)
    {
        network->derror.ptr.p_float[ntotal-nout+i] = network->y.ptr.p_float[i]-desiredy->ptr.p_float[i];
        *e = *e+ae_sqr(network->y.ptr.p_float[i]-desiredy->ptr.p_float[i], _state)/2;
    }
     ...
     ae_state *_state)
{
    ...
    *e = 0;
    ...
    else
    {
        ...
        for(i=0; i<=nout-1; i++)
        {
            s = s+desiredy->ptr.p_float[i];
        }
        for(i=0; i<=nout-1; i++)
        {
            network->derror.ptr.p_float[ntotal-nout+i] = s*network->y.ptr.p_float[i]-desiredy->ptr.p_float[i];
            *e = *e+mlpbase_safecrossentropy(desiredy->ptr.p_float[i], network->y.ptr.p_float[i], _state);
        }
    }
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=nin-1; i++)
    {
        if( ae_fp_neq(columnsigmas->ptr.p_float[i],0) )
        {
            neurons->ptr.p_float[i] = (x->ptr.p_float[i]-columnmeans->ptr.p_float[i])/columnsigmas->ptr.p_float[i];
        }
        else
        {
            neurons->ptr.p_float[i] = x->ptr.p_float[i]-columnmeans->ptr.p_float[i];
        }
    }
    ...
    for(i=0; i<=ntotal-1; i++)
    {
        ...
        if( structinfo->ptr.p_int[offs+0]>0||structinfo->ptr.p_int[offs+0]==-5 )
        {
             ...
             * Activation function
             */
            mlpactivationfunction(neurons->ptr.p_float[structinfo->ptr.p_int[offs+2]], structinfo->ptr.p_int[offs+0], &f, &df, &d2f, _state);
            neurons->ptr.p_float[i] = f;
            dfdnet->ptr.p_float[i] = df;
            continue;
        }
        if( structinfo->ptr.p_int[offs+0]==0 )
        {
            ...
            net = ae_v_dotproduct(&weights->ptr.p_float[w1], 1, &neurons->ptr.p_float[n1], 1, ae_v_len(w1,w2));
            neurons->ptr.p_float[i] = net;
            dfdnet->ptr.p_float[i] = 1.0;
            continue;
        }
        if( structinfo->ptr.p_int[offs+0]<0 )
        {
     ...
     * Extract result
     */
    ae_v_move(&y->ptr.p_float[0], 1, &neurons->ptr.p_float[ntotal-nout], 1, ae_v_len(0,nout-1));
    ...
    if( structinfo->ptr.p_int[6]==1 )
    {
        ...
        for(i=1; i<=nout-1; i++)
        {
            mx = ae_maxreal(mx, y->ptr.p_float[i], _state);
        }
        net = 0;
        for(i=0; i<=nout-1; i++)
        {
            y->ptr.p_float[i] = ae_exp(y->ptr.p_float[i]-mx, _state);
            net = net+y->ptr.p_float[i];
        }
        for(i=0; i<=nout-1; i++)
        {
            y->ptr.p_float[i] = y->ptr.p_float[i]/net;
        }
    }
    else
    {
        ...
        for(i=0; i<=nout-1; i++)
        {
            y->ptr.p_float[i] = y->ptr.p_float[i]*columnsigmas->ptr.p_float[nin+i]+columnmeans->ptr.p_float[nin+i];
        }
    }
}
     ...
     ae_state *_state)
{
    ...
    for(i=1; i<=network->hllayersizes.cnt-1; i++)
    {
        for(j=0; j<=network->hllayersizes.ptr.p_int[i]-1; j++)
        {
            ...
            ae_serializer_serialize_float(s, threshold, _state);
            for(k=0; k<=network->hllayersizes.ptr.p_int[i-1]-1; k++)
            {
                ae_serializer_serialize_float(s, mlpgetweight(network, i-1, k, i, j, _state), _state);
            }
        }
    }
    for(j=0; j<=nin-1; j++)
    {
        mlpgetinputscaling(network, j, &v0, &v1, _state);
        ae_serializer_serialize_float(s, v0, _state);
        ae_serializer_serialize_float(s, v1, _state);
    }
    for(j=0; j<=nout-1; j++)
    {
        mlpgetoutputscaling(network, j, &v0, &v1, _state);
     ...
     ae_state *_state)
{
    ...
    for(i=1; i<=layersizes.cnt-1; i++)
    {
        for(j=0; j<=layersizes.ptr.p_int[i]-1; j++)
        {
            ...
            ae_serializer_unserialize_float(s, &threshold, _state);
            mlpsetneuroninfo(network, i, j, fkind, threshold, _state);
            for(k=0; k<=layersizes.ptr.p_int[i-1]-1; k++)
            {
                ae_serializer_unserialize_float(s, &v0, _state);
    ...
    {
        ae_serializer_unserialize_float(s, &v0, _state);
        ae_serializer_unserialize_float(s, &v1, _state);
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=nin-1; i++)
    {
        network->columnmeans.ptr.p_float[i] = 0;
        network->columnsigmas.ptr.p_float[i] = 1;
    }
    if( !isclsnet )
    {
        for(i=0; i<=nout-1; i++)
        {
            network->columnmeans.ptr.p_float[nin+i] = 0;
            network->columnsigmas.ptr.p_float[nin+i] = 1;
        }
    }
    ae_frame_leave(_state);
     ...
     ae_state *_state)
{
    ...
    *e = 0;
    for(i=0; i<=wcount-1; i++)
    {
        zeros.ptr.p_float[i] = 0;
    }
    ae_v_move(&grad->ptr.p_float[0], 1, &zeros.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
    for(i=0; i<=wcount-1; i++)
    {
        ae_v_move(&h->ptr.pp_float[i][0], 1, &zeros.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
    }
    ...
    for(k=0; k<=ssize-1; k++)
    {
         ...
         */
        ae_v_move(&x.ptr.p_float[0], 1, &xy->ptr.pp_float[k][0], 1, ae_v_len(0,nin-1));
        if( mlpissoftmax(network, _state) )
        {
             ...
             * class labels outputs
             */
            kl = ae_round(xy->ptr.pp_float[k][nin], _state);
            for(i=0; i<=nout-1; i++)
            {
                if( i==kl )
                {
                    desiredy.ptr.p_float[i] = 1;
                }
                else
                {
                    desiredy.ptr.p_float[i] = 0;
                }
            }
        }
        else
        {
             ...
             * real outputs
             */
            ae_v_move(&desiredy.ptr.p_float[0], 1, &xy->ptr.pp_float[k][nin], 1, ae_v_len(0,nout-1));
        }
        if( naturalerr )
        {
         ...
         */
        *e = *e+et;
        ae_v_add(&grad->ptr.p_float[0], 1, &gt.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
        ...
        {
            offs = istart+i*mlpbase_nfieldwidth;
            ae_v_move(&rx.ptr.pp_float[i][0], 1, &zeros.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
            ae_v_move(&ry.ptr.pp_float[i][0], 1, &zeros.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
            if( network->structinfo.ptr.p_int[offs+0]>0||network->structinfo.ptr.p_int[offs+0]==-5 )
            {
                ...
                ae_v_move(&rx.ptr.pp_float[i][0], 1, &ry.ptr.pp_float[n1][0], 1, ae_v_len(0,wcount-1));
                v = network->dfdnet.ptr.p_float[i];
                ae_v_moved(&ry.ptr.pp_float[i][0], 1, &rx.ptr.pp_float[i][0], 1, ae_v_len(0,wcount-1), v);
                continue;
            }
            if( network->structinfo.ptr.p_int[offs+0]==0 )
            {
                ...
                for(j=n1; j<=n2; j++)
                {
                    v = network->weights.ptr.p_float[w1+j-n1];
                    ae_v_addd(&rx.ptr.pp_float[i][0], 1, &ry.ptr.pp_float[j][0], 1, ae_v_len(0,wcount-1), v);
                    rx.ptr.pp_float[i][w1+j-n1] = rx.ptr.pp_float[i][w1+j-n1]+network->neurons.ptr.p_float[j];
                }
                ae_v_move(&ry.ptr.pp_float[i][0], 1, &rx.ptr.pp_float[i][0], 1, ae_v_len(0,wcount-1));
                continue;
            }
            if( network->structinfo.ptr.p_int[offs+0]<0 )
            {
        ...
        {
            ae_v_move(&rdy.ptr.pp_float[i][0], 1, &zeros.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
        }
        if( network->structinfo.ptr.p_int[6]==0 )
        {
            ...
            for(i=0; i<=nout-1; i++)
            {
                 ...
                 */
                ae_v_move(&rx.ptr.pp_float[n2][0], 1, &ry.ptr.pp_float[n1][0], 1, ae_v_len(0,wcount-1));
                v = network->columnsigmas.ptr.p_float[nin+i];
                ae_v_moved(&ry.ptr.pp_float[n2][0], 1, &rx.ptr.pp_float[n2][0], 1, ae_v_len(0,wcount-1), v);
                
                /*
                 * Initialization of RDY
                 */
                ae_v_move(&rdy.ptr.pp_float[n2][0], 1, &ry.ptr.pp_float[n2][0], 1, ae_v_len(0,wcount-1));
                 ...
                 */
                df = network->columnsigmas.ptr.p_float[nin+i];
                ae_v_moved(&rdx.ptr.pp_float[n2][0], 1, &rdy.ptr.pp_float[n2][0], 1, ae_v_len(0,wcount-1), df);
                ae_v_add(&rdy.ptr.pp_float[n1][0], 1, &rdx.ptr.pp_float[n2][0], 1, ae_v_len(0,wcount-1));
            }
        }
        else
        {
            ...
            if( naturalerr )
            {
                ...
                for(i=0; i<=nout-1; i++)
                {
                    t = t+desiredy.ptr.p_float[i];
                }
                mx = network->neurons.ptr.p_float[ntotal-nout];
                for(i=0; i<=nout-1; i++)
                {
                    mx = ae_maxreal(mx, network->neurons.ptr.p_float[ntotal-nout+i], _state);
                }
                s = 0;
                for(i=0; i<=nout-1; i++)
                {
                    network->nwbuf.ptr.p_float[i] = ae_exp(network->neurons.ptr.p_float[ntotal-nout+i]-mx, _state);
                    s = s+network->nwbuf.ptr.p_float[i];
                }
                for(i=0; i<=nout-1; i++)
                {
                    for(j=0; j<=nout-1; j++)
                    {
                        if( j==i )
                        {
                            deidyj = t*network->nwbuf.ptr.p_float[i]*(s-network->nwbuf.ptr.p_float[i])/ae_sqr(s, _state);
                            ae_v_addd(&rdy.ptr.pp_float[ntotal-nout+i][0], 1, &ry.ptr.pp_float[ntotal-nout+i][0], 1, ae_v_len(0,wcount-1), deidyj);
                        }
                        else
                        {
                            deidyj = -t*network->nwbuf.ptr.p_float[i]*network->nwbuf.ptr.p_float[j]/ae_sqr(s, _state);
                            ae_v_addd(&rdy.ptr.pp_float[ntotal-nout+i][0], 1, &ry.ptr.pp_float[ntotal-nout+j][0], 1, ae_v_len(0,wcount-1), deidyj);
                        }
                    }
                }
            }
            else
            {
                ...
                for(i=0; i<=nout-1; i++)
                {
                    network->nwbuf.ptr.p_float[i] = ae_exp(network->neurons.ptr.p_float[ntotal-nout+i]-mx, _state);
                    s = s+network->nwbuf.ptr.p_float[i];
                    s2 = s2+ae_sqr(network->nwbuf.ptr.p_float[i], _state);
                }
                q = 0;
                for(i=0; i<=nout-1; i++)
                {
                    q = q+(network->y.ptr.p_float[i]-desiredy.ptr.p_float[i])*network->nwbuf.ptr.p_float[i];
                }
                for(i=0; i<=nout-1; i++)
                {
                    z = -q+(network->y.ptr.p_float[i]-desiredy.ptr.p_float[i])*s;
                    expi = network->nwbuf.ptr.p_float[i];
                    for(j=0; j<=nout-1; j++)
                    {
                        expj = network->nwbuf.ptr.p_float[j];
                        if( j==i )
                        {
                        ...
                        {
                            deidyj = expi*expj/ae_sqr(s, _state)*(s2/ae_sqr(s, _state)-2*z/s-(expi+expj)/s+(network->y.ptr.p_float[i]-desiredy.ptr.p_float[i])-(network->y.ptr.p_float[j]-desiredy.ptr.p_float[j]));
                        }
                        ae_v_addd(&rdy.ptr.pp_float[ntotal-nout+i][0], 1, &ry.ptr.pp_float[ntotal-nout+j][0], 1, ae_v_len(0,wcount-1), deidyj);
                    }
                }
        ...
        for(i=ntotal-1; i>=0; i--)
        {
            ...
            if( network->structinfo.ptr.p_int[offs+0]>0||network->structinfo.ptr.p_int[offs+0]==-5 )
            {
                 ...
                 */
                mlpactivationfunction(network->neurons.ptr.p_float[n1], network->structinfo.ptr.p_int[offs+0], &f, &df, &d2f, _state);
                v = d2f*network->derror.ptr.p_float[i];
                ae_v_moved(&rdx.ptr.pp_float[i][0], 1, &rdy.ptr.pp_float[i][0], 1, ae_v_len(0,wcount-1), df);
                ae_v_addd(&rdx.ptr.pp_float[i][0], 1, &rx.ptr.pp_float[i][0], 1, ae_v_len(0,wcount-1), v);
                 ...
                 */
                ae_v_add(&rdy.ptr.pp_float[n1][0], 1, &rdx.ptr.pp_float[i][0], 1, ae_v_len(0,wcount-1));
                continue;
            }
            if( network->structinfo.ptr.p_int[offs+0]==0 )
            {
                 ...
                 * First, calculate R(dE/dX).
                 */
                ae_v_move(&rdx.ptr.pp_float[i][0], 1, &rdy.ptr.pp_float[i][0], 1, ae_v_len(0,wcount-1));
                ...
                for(j=w1; j<=w2; j++)
                {
                    v = network->neurons.ptr.p_float[n1+j-w1];
                    ae_v_addd(&h->ptr.pp_float[j][0], 1, &rdx.ptr.pp_float[i][0], 1, ae_v_len(0,wcount-1), v);
                    v = network->derror.ptr.p_float[i];
                    ae_v_addd(&h->ptr.pp_float[j][0], 1, &ry.ptr.pp_float[n1+j-w1][0], 1, ae_v_len(0,wcount-1), v);
                }
                ...
                for(j=w1; j<=w2; j++)
                {
                    v = network->weights.ptr.p_float[j];
                    ae_v_addd(&rdy.ptr.pp_float[n1+j-w1][0], 1, &rdx.ptr.pp_float[i][0], 1, ae_v_len(0,wcount-1), v);
                    rdy.ptr.pp_float[n1+j-w1][j] = rdy.ptr.pp_float[n1+j-w1][j]+network->derror.ptr.p_float[i];
                }
                continue;
            }
            if( network->structinfo.ptr.p_int[offs+0]<0 )
     ...
     ae_state *_state)
{
    ...
    if( network->structinfo.ptr.p_int[6]==1 )
    {
        ...
        if( !naturalerrorfunc )
        {
            ...
            {
                network->nwbuf.ptr.p_float[i] = ae_exp(network->neurons.ptr.p_float[ntotal-nout+i]-mx, _state);
                net = net+network->nwbuf.ptr.p_float[i];
            }
            v = ae_v_dotproduct(&network->derror.ptr.p_float[ntotal-nout], 1, &network->nwbuf.ptr.p_float[0], 1, ae_v_len(ntotal-nout,ntotal-1));
            for(i=0; i<=nout-1; i++)
            {
                fown = network->nwbuf.ptr.p_float[i];
                deown = network->derror.ptr.p_float[ntotal-nout+i];
                network->nwbuf.ptr.p_float[nout+i] = (-v+deown*fown+deown*(net-fown))*fown/ae_sqr(net, _state);
            }
            for(i=0; i<=nout-1; i++)
            {
                network->derror.ptr.p_float[ntotal-nout+i] = network->nwbuf.ptr.p_float[nout+i];
            }
        }
    }
    else
    {
        ...
        for(i=0; i<=nout-1; i++)
        {
            network->derror.ptr.p_float[ntotal-nout+i] = network->derror.ptr.p_float[ntotal-nout+i]*network->columnsigmas.ptr.p_float[nin+i];
        }
    }
    ...
    for(i=ntotal-1; i>=0; i--)
    {
        ...
        if( network->structinfo.ptr.p_int[offs+0]>0||network->structinfo.ptr.p_int[offs+0]==-5 )
        {
             ...
             * Activation function
             */
            dedf = network->derror.ptr.p_float[i];
            dfdnet = network->dfdnet.ptr.p_float[i];
            derror->ptr.p_float[network->structinfo.ptr.p_int[offs+2]] = derror->ptr.p_float[network->structinfo.ptr.p_int[offs+2]]+dedf*dfdnet;
            continue;
        }
        if( network->structinfo.ptr.p_int[offs+0]==0 )
        {
            ...
            dfdnet = 1.0;
            v = dedf*dfdnet;
            ae_v_moved(&grad->ptr.p_float[w1], 1, &neurons->ptr.p_float[n1], 1, ae_v_len(w1,w2), v);
            ae_v_addd(&derror->ptr.p_float[n1], 1, &weights->ptr.p_float[w1], 1, ae_v_len(n1,n2), v);
            continue;
        }
        if( network->structinfo.ptr.p_int[offs+0]<0 )
        {
     ...
     ae_state *_state)
{
    ...
    for(j=0; j<=csize-1; j++)
    {
        network->chunks.ptr.pp_float[izeros][j] = 0;
    }
    ...
    for(i=0; i<=nin-1; i++)
    {
        for(j=0; j<=csize-1; j++)
        {
            if( ae_fp_neq(network->columnsigmas.ptr.p_float[i],0) )
            {
                network->chunks.ptr.pp_float[i][j] = (xy->ptr.pp_float[c1+j][i]-network->columnmeans.ptr.p_float[i])/network->columnsigmas.ptr.p_float[i];
            }
            else
            {
                network->chunks.ptr.pp_float[i][j] = xy->ptr.pp_float[c1+j][i]-network->columnmeans.ptr.p_float[i];
            }
        }
    }
    for(i=0; i<=ntotal-1; i++)
    {
        ...
        if( network->structinfo.ptr.p_int[offs+0]>0||network->structinfo.ptr.p_int[offs+0]==-5 )
        {
             ...
             */
            n1 = network->structinfo.ptr.p_int[offs+2];
            ae_v_move(&network->chunks.ptr.pp_float[i][0], 1, &network->chunks.ptr.pp_float[n1][0], 1, ae_v_len(0,csize-1));
            for(j=0; j<=csize-1; j++)
            {
                mlpactivationfunction(network->chunks.ptr.pp_float[i][j], network->structinfo.ptr.p_int[offs+0], &f, &df, &d2f, _state);
                network->chunks.ptr.pp_float[i][j] = f;
                network->chunks.ptr.pp_float[idfdnet+i][j] = df;
            }
            continue;
        }
        if( network->structinfo.ptr.p_int[offs+0]==0 )
        {
            ...
            w1 = network->structinfo.ptr.p_int[offs+3];
            w2 = w1+network->structinfo.ptr.p_int[offs+1]-1;
            ae_v_move(&network->chunks.ptr.pp_float[i][0], 1, &network->chunks.ptr.pp_float[izeros][0], 1, ae_v_len(0,csize-1));
            for(j=n1; j<=n2; j++)
            {
                v = network->weights.ptr.p_float[w1+j-n1];
                ae_v_addd(&network->chunks.ptr.pp_float[i][0], 1, &network->chunks.ptr.pp_float[j][0], 1, ae_v_len(0,csize-1), v);
            }
            continue;
        }
        if( network->structinfo.ptr.p_int[offs+0]<0 )
        {
            ...
            if( network->structinfo.ptr.p_int[offs+0]==-3 )
            {
                ...
                for(k=0; k<=csize-1; k++)
                {
                    network->chunks.ptr.pp_float[i][k] = -1;
                }
                bflag = ae_true;
            }
            if( network->structinfo.ptr.p_int[offs+0]==-4 )
            {
                ...
                for(k=0; k<=csize-1; k++)
                {
                    network->chunks.ptr.pp_float[i][k] = 0;
                }
                bflag = ae_true;
            }
    ...
    for(i=0; i<=ntotal-1; i++)
    {
        ae_v_move(&network->chunks.ptr.pp_float[iderror+i][0], 1, &network->chunks.ptr.pp_float[izeros][0], 1, ae_v_len(0,csize-1));
    }
    ...
    if( network->structinfo.ptr.p_int[6]==1 )
    {
        ...
        for(k=0; k<=csize-1; k++)
        {
             ...
             * Normalize
             */
            mx = network->chunks.ptr.pp_float[ntotal-nout][k];
            for(i=1; i<=nout-1; i++)
            {
                mx = ae_maxreal(mx, network->chunks.ptr.pp_float[ntotal-nout+i][k], _state);
            }
            net = 0;
            for(i=0; i<=nout-1; i++)
            {
                network->nwbuf.ptr.p_float[i] = ae_exp(network->chunks.ptr.pp_float[ntotal-nout+i][k]-mx, _state);
                net = net+network->nwbuf.ptr.p_float[i];
            }
            ...
            if( naturalerrorfunc )
            {
                ...
                kl = ae_round(xy->ptr.pp_float[cstart+k][nin], _state);
                for(i=0; i<=nout-1; i++)
                {
                    if( i==kl )
                    {
                    ...
                    network->chunks.ptr.pp_float[iderror+ntotal-nout+i][k] = s*network->nwbuf.ptr.p_float[i]/net-v;
                    *e = *e+mlpbase_safecrossentropy(v, network->nwbuf.ptr.p_float[i]/net, _state);
                }
            }
            else
            {
                ...
                for(i=0; i<=nout-1; i++)
                {
                    if( i==kl )
                    {
                        v = network->nwbuf.ptr.p_float[i]/net-1;
                    }
                    else
                    {
                        v = network->nwbuf.ptr.p_float[i]/net;
                    }
                    network->nwbuf.ptr.p_float[nout+i] = v;
                 ...
                 * From dError/dOut(normalized) to dError/dOut(non-normalized)
                 */
                v = ae_v_dotproduct(&network->nwbuf.ptr.p_float[nout], 1, &network->nwbuf.ptr.p_float[0], 1, ae_v_len(nout,2*nout-1));
                for(i=0; i<=nout-1; i++)
                {
                    fown = network->nwbuf.ptr.p_float[i];
                    deown = network->nwbuf.ptr.p_float[nout+i];
                    network->chunks.ptr.pp_float[iderror+ntotal-nout+i][k] = (-v+deown*fown+deown*(net-fown))*fown/ae_sqr(net, _state);
                }
            }
        }
    }
    else
    {
        ...
        for(i=0; i<=nout-1; i++)
        {
            for(j=0; j<=csize-1; j++)
            {
                v = network->chunks.ptr.pp_float[ntotal-nout+i][j]*network->columnsigmas.ptr.p_float[nin+i]+network->columnmeans.ptr.p_float[nin+i]-xy->ptr.pp_float[cstart+j][nin+i];
                network->chunks.ptr.pp_float[iderror+ntotal-nout+i][j] = v*network->columnsigmas.ptr.p_float[nin+i];
                *e = *e+ae_sqr(v, _state)/2;
            }
        }
    }
    ...
    for(i=ntotal-1; i>=0; i--)
    {
        ...
        if( network->structinfo.ptr.p_int[offs+0]>0||network->structinfo.ptr.p_int[offs+0]==-5 )
        {
            ...
            for(k=0; k<=csize-1; k++)
            {
                network->chunks.ptr.pp_float[iderror+i][k] = network->chunks.ptr.pp_float[iderror+i][k]*network->chunks.ptr.pp_float[idfdnet+i][k];
            }
            ae_v_add(&network->chunks.ptr.pp_float[iderror+n1][0], 1, &network->chunks.ptr.pp_float[iderror+i][0], 1, ae_v_len(0,csize-1));
            continue;
        }
        if( network->structinfo.ptr.p_int[offs+0]==0 )
        {
            ...
            for(j=w1; j<=w2; j++)
            {
                v = ae_v_dotproduct(&network->chunks.ptr.pp_float[n1+j-w1][0], 1, &network->chunks.ptr.pp_float[iderror+i][0], 1, ae_v_len(0,csize-1));
                grad->ptr.p_float[j] = grad->ptr.p_float[j]+v;
            }
            for(j=n1; j<=n2; j++)
            {
                v = network->weights.ptr.p_float[w1+j-n1];
                ae_v_addd(&network->chunks.ptr.pp_float[iderror+j][0], 1, &network->chunks.ptr.pp_float[iderror+i][0], 1, ae_v_len(0,csize-1), v);
            }
            continue;
        }
        if( network->structinfo.ptr.p_int[offs+0]<0 )
     ...
     ae_state *_state)
{
    ...
    *info = 1;
    ...
    lm->w.ptr.p_float[0] = ssize;
    lm->w.ptr.p_float[1] = logit_logitvnum;
    lm->w.ptr.p_float[2] = nvars;
    lm->w.ptr.p_float[3] = nclasses;
    lm->w.ptr.p_float[4] = offs;
    ...
    {
        if( ae_round(xy->ptr.pp_float[i][nvars], _state)!=ae_round(xy->ptr.pp_float[i-1][nvars], _state) )
        {
            allsame = ae_false;
        }
    }
    if( allsame )
    {
        ...
        k = ae_round(xy->ptr.pp_float[0][nvars], _state);
        if( k==nclasses-1 )
        {
            for(i=0; i<=nclasses-2; i++)
            {
                lm->w.ptr.p_float[offs+i*(nvars+1)+nvars] = -v;
            }
        }
        else
        {
            for(i=0; i<=nclasses-2; i++)
            {
                ...
                {
                    lm->w.ptr.p_float[offs+i*(nvars+1)+nvars] = 0;
                }
            }
        }
        ae_frame_leave(_state);
    ...
    for(i=0; i<=wcount-1; i++)
    {
        network.weights.ptr.p_float[i] = (2*ae_randomreal(_state)-1)/nvars;
    }
    ...
    for(k=0; k<=wcount/3+10; k++)
    {
        ...
        v = ae_v_dotproduct(&network.weights.ptr.p_float[0], 1, &network.weights.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
        e = e+0.5*decay*v;
        ae_v_addd(&g.ptr.p_float[0], 1, &network.weights.ptr.p_float[0], 1, ae_v_len(0,wcount-1), decay);
        rep->ngrad = rep->ngrad+1;
        
        /*
         * Setup optimization scheme
         */
        ae_v_moveneg(&wdir.ptr.p_float[0], 1, &g.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
        v = ae_v_dotproduct(&wdir.ptr.p_float[0], 1, &wdir.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
        wstep = ae_sqrt(v, _state);
        v = 1/ae_sqrt(v, _state);
        ae_v_muld(&wdir.ptr.p_float[0], 1, ae_v_len(0,wcount-1), v);
        mcstage = 0;
    ...
    for(;;)
    {
        ...
        {
            h.ptr.pp_float[k][k] = h.ptr.pp_float[k][k]+decay;
        }
        ...
        if( spd )
        {
             ...
             */
            ae_v_muld(&wdir.ptr.p_float[0], 1, ae_v_len(0,wcount-1), -1);
            spd = ae_true;
        }
        else
        {
     ...
     */
    ae_v_move(&lm->w.ptr.p_float[offs], 1, &network.weights.ptr.p_float[0], 1, ae_v_len(offs,offs+wcount-1));
    for(k=0; k<=nvars-1; k++)
    {
        for(i=0; i<=nclasses-2; i++)
        {
            s = network.columnsigmas.ptr.p_float[k];
            if( ae_fp_eq(s,0) )
            {
                s = 1;
            }
            j = offs+(nvars+1)*i;
            v = lm->w.ptr.p_float[j+k];
            lm->w.ptr.p_float[j+k] = v/s;
            lm->w.ptr.p_float[j+nvars] = lm->w.ptr.p_float[j+nvars]+v*network.columnmeans.ptr.p_float[k]/s;
        }
    }
    for(k=0; k<=nclasses-2; k++)
    {
        lm->w.ptr.p_float[offs+(nvars+1)*k+nvars] = -lm->w.ptr.p_float[offs+(nvars+1)*k+nvars];
    }
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_eq(lm->w.ptr.p_float[1],logit_logitvnum), "MNLProcess: unexpected model version", _state);
    nvars = ae_round(lm->w.ptr.p_float[2], _state);
    nclasses = ae_round(lm->w.ptr.p_float[3], _state);
    offs = ae_round(lm->w.ptr.p_float[4], _state);
    logit_mnliexp(&lm->w, x, _state);
    s = 0;
    i1 = offs+(nvars+1)*(nclasses-1);
    for(i=i1; i<=i1+nclasses-1; i++)
    {
        s = s+lm->w.ptr.p_float[i];
    }
    if( y->cnt<nclasses )
    {
    ...
    for(i=0; i<=nclasses-1; i++)
    {
        y->ptr.p_float[i] = lm->w.ptr.p_float[i1+i]/s;
    }
}
     ...
     ae_state *_state)
{
    ...
    *nclasses = 0;
    ...
    ae_assert(ae_fp_eq(lm->w.ptr.p_float[1],logit_logitvnum), "MNLUnpack: unexpected model version", _state);
    *nvars = ae_round(lm->w.ptr.p_float[2], _state);
    *nclasses = ae_round(lm->w.ptr.p_float[3], _state);
    offs = ae_round(lm->w.ptr.p_float[4], _state);
    ...
    for(i=0; i<=*nclasses-2; i++)
    {
        ae_v_move(&a->ptr.pp_float[i][0], 1, &lm->w.ptr.p_float[offs+i*(*nvars+1)], 1, ae_v_len(0,*nvars));
    }
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=nclasses-2; i++)
    {
        ae_v_move(&lm->w.ptr.p_float[offs+i*(nvars+1)], 1, &a->ptr.pp_float[i][0], 1, ae_v_len(offs+i*(nvars+1),offs+i*(nvars+1)+nvars));
    }
}
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_eq(lm->w.ptr.p_float[1],logit_logitvnum), "MNLClsError: unexpected model version", _state);
    nvars = ae_round(lm->w.ptr.p_float[2], _state);
    nclasses = ae_round(lm->w.ptr.p_float[3], _state);
    ...
    for(i=0; i<=npoints-1; i++)
    {
        ae_assert(ae_round(xy->ptr.pp_float[i][nvars], _state)>=0&&ae_round(xy->ptr.pp_float[i][nvars], _state)<nclasses, "MNLAvgCE: incorrect class number!", _state);
        
        /*
         * Process
         */
        ae_v_move(&workx.ptr.p_float[0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1));
        mnlprocess(lm, &workx, &worky, _state);
        if( ae_fp_greater(worky.ptr.p_float[ae_round(xy->ptr.pp_float[i][nvars], _state)],0) )
        {
            result = result-ae_log(worky.ptr.p_float[ae_round(xy->ptr.pp_float[i][nvars], _state)], _state);
        }
        else
        {
            result = result-ae_log(ae_minrealnumber, _state);
     ...
     ae_state *_state)
{
    ...
    result = (float)mnlclserror(lm, xy, npoints, _state)/(float)npoints;
    return result;
}
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_round(lm->w.ptr.p_float[1], _state)==logit_logitvnum, "MNLRMSError: Incorrect MNL version!", _state);
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=npoints-1; i++)
    {
         ...
         * compare
         */
        if( nmax!=ae_round(xy->ptr.pp_float[i][nvars], _state) )
        {
            result = result+1;
        }
    }
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_eq(w->ptr.p_float[1],logit_logitvnum), "LOGIT: unexpected model version", _state);
    nvars = ae_round(w->ptr.p_float[2], _state);
    nclasses = ae_round(w->ptr.p_float[3], _state);
    offs = ae_round(w->ptr.p_float[4], _state);
    i1 = offs+(nvars+1)*(nclasses-1);
    for(i=0; i<=nclasses-2; i++)
    {
        v = ae_v_dotproduct(&w->ptr.p_float[offs+i*(nvars+1)], 1, &x->ptr.p_float[0], 1, ae_v_len(offs+i*(nvars+1),offs+i*(nvars+1)+nvars-1));
        w->ptr.p_float[i1+i] = v+w->ptr.p_float[offs+i*(nvars+1)+nvars];
    }
    w->ptr.p_float[i1+nclasses-1] = 0;
    mx = 0;
    for(i=i1; i<=i1+nclasses-1; i++)
    {
        mx = ae_maxreal(mx, w->ptr.p_float[i], _state);
    }
    for(i=i1; i<=i1+nclasses-1; i++)
    {
        w->ptr.p_float[i] = ae_exp(w->ptr.p_float[i]-mx, _state);
    }
}
     ...
     ae_state *_state)
{
    ...
    *avgrel = 0;
    ...
    ae_assert(ae_round(lm->w.ptr.p_float[1], _state)==logit_logitvnum, "MNL unit: Incorrect MNL version!", _state);
    nvars = ae_round(lm->w.ptr.p_float[2], _state);
    nclasses = ae_round(lm->w.ptr.p_float[3], _state);
    ae_vector_set_length(&workx, nvars-1+1, _state);
    ae_vector_set_length(&y, nclasses-1+1, _state);
    ...
    for(i=0; i<=npoints-1; i++)
    {
        ...
        dy.ptr.p_float[0] = xy->ptr.pp_float[i][nvars];
        dserraccumulate(&buf, &y, &dy, _state);
    }
    dserrfinish(&buf, _state);
    *relcls = buf.ptr.p_float[0];
    *avgce = buf.ptr.p_float[1];
    *rms = buf.ptr.p_float[2];
    *avg = buf.ptr.p_float[3];
    *avgrel = buf.ptr.p_float[4];
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=k-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
            ae_assert(ae_fp_greater_eq(xy->ptr.pp_float[i][j],0), "MCPDAddTrack: XY contains negative elements", _state);
        }
    }
    if( k<2 )
    {
    ...
    for(i=0; i<=k-2; i++)
    {
        ...
        for(j=0; j<=n-1; j++)
        {
            ...
            {
                s0 = s0+xy->ptr.pp_float[i][j];
            }
            if( s->states.ptr.p_int[j]<=0 )
            {
                s1 = s1+xy->ptr.pp_float[i+1][j];
            }
        }
        if( ae_fp_greater(s0,0)&&ae_fp_greater(s1,0) )
        {
            for(j=0; j<=n-1; j++)
            {
                if( s->states.ptr.p_int[j]>=0 )
                {
                    s->data.ptr.pp_float[s->npairs][j] = xy->ptr.pp_float[i][j]/s0;
                }
                else
                {
                    s->data.ptr.pp_float[s->npairs][j] = 0.0;
                }
                if( s->states.ptr.p_int[j]<=0 )
                {
                    s->data.ptr.pp_float[s->npairs][n+j] = xy->ptr.pp_float[i+1][j]/s1;
                }
                else
                {
                    s->data.ptr.pp_float[s->npairs][n+j] = 0.0;
                }
            }
            s->npairs = s->npairs+1;
        }
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
            ae_assert(ae_isfinite(ec->ptr.pp_float[i][j], _state)||ae_isnan(ec->ptr.pp_float[i][j], _state), "MCPDSetEC: EC containts infinite elements", _state);
            s->ec.ptr.pp_float[i][j] = ec->ptr.pp_float[i][j];
        }
    }
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
            ae_assert(ae_isfinite(bndl->ptr.pp_float[i][j], _state)||ae_isneginf(bndl->ptr.pp_float[i][j], _state), "MCPDSetBC: BndL containts NAN or +INF", _state);
            ae_assert(ae_isfinite(bndu->ptr.pp_float[i][j], _state)||ae_isposinf(bndu->ptr.pp_float[i][j], _state), "MCPDSetBC: BndU containts NAN or -INF", _state);
            s->bndl.ptr.pp_float[i][j] = bndl->ptr.pp_float[i][j];
            s->bndu.ptr.pp_float[i][j] = bndu->ptr.pp_float[i][j];
        }
    }
}
     ...
     ae_state *_state)
{
    ...
    s->bndl.ptr.pp_float[i][j] = bndl;
    s->bndu.ptr.pp_float[i][j] = bndu;
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=k-1; i++)
    {
        for(j=0; j<=n*n; j++)
        {
            s->c.ptr.pp_float[i][j] = c->ptr.pp_float[i][j];
        }
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
            ae_assert(ae_isfinite(pp->ptr.pp_float[i][j], _state), "MCPDSetPrior: PP containts infinite elements", _state);
            ae_assert(ae_fp_greater_eq(pp->ptr.pp_float[i][j],0.0)&&ae_fp_less_eq(pp->ptr.pp_float[i][j],1.0), "MCPDSetPrior: PP[i,j] is less than 0.0 or greater than 1.0", _state);
            s->priorp.ptr.pp_float[i][j] = pp->ptr.pp_float[i][j];
        }
    }
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        ae_assert(ae_isfinite(pw->ptr.p_float[i], _state), "MCPDSetPredictionWeights: PW containts infinite or NAN elements", _state);
        ae_assert(ae_fp_greater_eq(pw->ptr.p_float[i],0), "MCPDSetPredictionWeights: PW containts negative elements", _state);
        s->pw.ptr.p_float[i] = pw->ptr.p_float[i];
    }
}
...
void mcpdsolve(mcpdstate* s, ae_state *_state)
{
    ...
    for(k=0; k<=n-1; k++)
    {
        for(k2=0; k2<=n-1; k2++)
        {
            s->p.ptr.pp_float[k][k2] = _state->v_nan;
        }
    }
    ...
    for(i=0; i<=n-1; i++)
    {
        if( ae_fp_eq(s->pw.ptr.p_float[i],0) )
        {
            v = 0;
            k = 0;
            for(j=0; j<=npairs-1; j++)
            {
                if( ae_fp_neq(s->data.ptr.pp_float[j][n+i],0) )
                {
                    v = v+s->data.ptr.pp_float[j][n+i];
                    k = k+1;
                }
            }
            if( k!=0 )
            {
                s->effectivew.ptr.p_float[i] = k/v;
            }
            else
            {
                s->effectivew.ptr.p_float[i] = 1.0;
            }
        }
        else
        {
            s->effectivew.ptr.p_float[i] = s->pw.ptr.p_float[i];
        }
    }
    for(i=0; i<=n-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
            s->h.ptr.p_float[i*n+j] = 2*s->regterm;
        }
    }
    for(k=0; k<=npairs-1; k++)
    {
        for(i=0; i<=n-1; i++)
        {
            for(j=0; j<=n-1; j++)
            {
                s->h.ptr.p_float[i*n+j] = s->h.ptr.p_float[i*n+j]+2*ae_sqr(s->effectivew.ptr.p_float[i], _state)*ae_sqr(s->data.ptr.pp_float[k][j], _state);
            }
        }
    }
    for(i=0; i<=n-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
            if( ae_fp_eq(s->h.ptr.p_float[i*n+j],0) )
            {
                s->h.ptr.p_float[i*n+j] = 1;
            }
        }
    }
    ...
    for(i=0; i<=n-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
             ...
             */
            s->effectivebndl.ptr.p_float[i*n+j] = 0.0;
            if( s->states.ptr.p_int[i]>0||s->states.ptr.p_int[j]<0 )
            {
                s->effectivebndu.ptr.p_float[i*n+j] = 0.0;
            }
            else
            {
                s->effectivebndu.ptr.p_float[i*n+j] = 1.0;
            }
             ...
             */
            if( ae_isfinite(s->bndl.ptr.pp_float[i][j], _state)&&ae_fp_greater(s->bndl.ptr.pp_float[i][j],s->effectivebndl.ptr.p_float[i*n+j]) )
            {
                s->effectivebndl.ptr.p_float[i*n+j] = s->bndl.ptr.pp_float[i][j];
            }
            if( ae_isfinite(s->bndu.ptr.pp_float[i][j], _state)&&ae_fp_less(s->bndu.ptr.pp_float[i][j],s->effectivebndu.ptr.p_float[i*n+j]) )
            {
                s->effectivebndu.ptr.p_float[i*n+j] = s->bndu.ptr.pp_float[i][j];
            }
            if( ae_fp_greater(s->effectivebndl.ptr.p_float[i*n+j],s->effectivebndu.ptr.p_float[i*n+j]) )
            {
             ...
             * This code checks consistency of such combination.
             */
            if( ae_isfinite(s->ec.ptr.pp_float[i][j], _state) )
            {
                if( ae_fp_less(s->ec.ptr.pp_float[i][j],s->effectivebndl.ptr.p_float[i*n+j])||ae_fp_greater(s->ec.ptr.pp_float[i][j],s->effectivebndu.ptr.p_float[i*n+j]) )
                {
                    s->repterminationtype = -3;
                    return;
                }
                s->effectivebndl.ptr.p_float[i*n+j] = s->ec.ptr.pp_float[i][j];
                s->effectivebndu.ptr.p_float[i*n+j] = s->ec.ptr.pp_float[i][j];
            }
        }
    }
    ...
    for(i=0; i<=s->ccnt-1; i++)
    {
        for(j=0; j<=n*n; j++)
        {
            s->effectivec.ptr.pp_float[i][j] = s->c.ptr.pp_float[i][j];
        }
    ...
    for(i=0; i<=n-1; i++)
    {
        if( s->states.ptr.p_int[i]>=0 )
        {
            for(k=0; k<=n*n-1; k++)
            {
                s->effectivec.ptr.pp_float[ccnt][k] = 0;
            }
            for(k=0; k<=n-1; k++)
            {
                s->effectivec.ptr.pp_float[ccnt][k*n+i] = 1;
            }
            s->effectivec.ptr.pp_float[ccnt][n*n] = 1.0;
    ...
    for(i=0; i<=n-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
            s->tmpp.ptr.p_float[i*n+j] = (float)1/(float)n;
        }
    }
    ...
    while(minbleiciteration(&s->bs, _state))
    {
        ...
        if( s->bs.needfg )
        {
            ...
            for(i=0; i<=n-1; i++)
            {
                for(j=0; j<=n-1; j++)
                {
                    s->bs.f = s->bs.f+vv*ae_sqr(s->bs.x.ptr.p_float[i*n+j]-s->priorp.ptr.pp_float[i][j], _state);
                    s->bs.g.ptr.p_float[i*n+j] = 2*vv*(s->bs.x.ptr.p_float[i*n+j]-s->priorp.ptr.pp_float[i][j]);
                }
            }
            ...
            for(k=0; k<=npairs-1; k++)
            {
                for(i=0; i<=n-1; i++)
                {
                    v = ae_v_dotproduct(&s->bs.x.ptr.p_float[i*n], 1, &s->data.ptr.pp_float[k][0], 1, ae_v_len(i*n,i*n+n-1));
                    vv = s->effectivew.ptr.p_float[i];
                    s->bs.f = s->bs.f+ae_sqr(vv*(v-s->data.ptr.pp_float[k][n+i]), _state);
                    for(j=0; j<=n-1; j++)
                    {
                        s->bs.g.ptr.p_float[i*n+j] = s->bs.g.ptr.p_float[i*n+j]+2*vv*vv*(v-s->data.ptr.pp_float[k][n+i])*s->data.ptr.pp_float[k][j];
                    }
                }
            }
    ...
    for(i=0; i<=n-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
            s->p.ptr.pp_float[i][j] = s->tmpp.ptr.p_float[i*n+j];
        }
    }
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=s->n-1; i++)
    {
        for(j=0; j<=s->n-1; j++)
        {
            p->ptr.pp_float[i][j] = s->p.ptr.pp_float[i][j];
        }
    }
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
            s->p.ptr.pp_float[i][j] = 0.0;
            s->priorp.ptr.pp_float[i][j] = 0.0;
            s->bndl.ptr.pp_float[i][j] = _state->v_neginf;
            s->bndu.ptr.pp_float[i][j] = _state->v_posinf;
            s->ec.ptr.pp_float[i][j] = _state->v_nan;
        }
        s->pw.ptr.p_float[i] = 0.0;
        s->priorp.ptr.pp_float[i][i] = 1.0;
    }
    ae_matrix_set_length(&s->data, 1, 2*n, _state);
    for(i=0; i<=2*n-1; i++)
    {
        s->data.ptr.pp_float[0][i] = 0.0;
    }
    for(i=0; i<=n*n-1; i++)
    {
        s->tmpp.ptr.p_float[i] = 0.0;
    }
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    if( mlpissoftmax(network, _state) )
    {
        for(i=0; i<=npoints-1; i++)
        {
            if( ae_round(xy->ptr.pp_float[i][nin], _state)<0||ae_round(xy->ptr.pp_float[i][nin], _state)>=nout )
            {
                *info = -2;
                ae_frame_leave(_state);
                return;
    ...
    *info = 2;
    ...
    for(pass=1; pass<=restarts; pass++)
    {
         ...
         */
        ae_v_move(&wbase.ptr.p_float[0], 1, &network->weights.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
        ...
        while(minlbfgsiteration(&state, _state))
        {
             ...
             * gradient
             */
            ae_v_move(&network->weights.ptr.p_float[0], 1, &state.x.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
            ...
            ae_v_addd(&state.g.ptr.p_float[0], 1, &network->weights.ptr.p_float[0], 1, ae_v_len(0,wcount-1), decay);
        ...
        ae_v_move(&network->weights.ptr.p_float[0], 1, &wbase.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
        ...
        for(;;)
        {
            ...
            for(i=0; i<=wcount-1; i++)
            {
                ae_v_move(&hmod.ptr.pp_float[i][0], 1, &h.ptr.pp_float[i][0], 1, ae_v_len(0,wcount-1));
                hmod.ptr.pp_float[i][i] = hmod.ptr.pp_float[i][i]+lambdav;
            }
             ...
             */
            ae_v_add(&network->weights.ptr.p_float[0], 1, &wdir.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
            xnorm2 = ae_v_dotproduct(&network->weights.ptr.p_float[0], 1, &network->weights.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
            stepnorm = ae_v_dotproduct(&wdir.ptr.p_float[0], 1, &wdir.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
            ...
            while(minlbfgsiteration(&state, _state))
            {
                ...
                for(i=0; i<=wcount-1; i++)
                {
                    v = ae_v_dotproduct(&state.x.ptr.p_float[i], 1, &hmod.ptr.pp_float[i][i], 1, ae_v_len(i,wcount-1));
                    network->weights.ptr.p_float[i] = wbase.ptr.p_float[i]+v;
                }
                mlpgradbatch(network, xy, npoints, &state.f, &g, _state);
                for(i=0; i<=wcount-1; i++)
                {
                    state.g.ptr.p_float[i] = 0;
                }
                for(i=0; i<=wcount-1; i++)
                {
                    v = g.ptr.p_float[i];
                    ae_v_addd(&state.g.ptr.p_float[i], 1, &hmod.ptr.pp_float[i][i], 1, ae_v_len(i,wcount-1), v);
                }
                ...
                for(i=0; i<=wcount-1; i++)
                {
                    v = decay*network->weights.ptr.p_float[i];
                    ae_v_addd(&state.g.ptr.p_float[i], 1, &hmod.ptr.pp_float[i][i], 1, ae_v_len(i,wcount-1), v);
                }
            ...
            for(i=0; i<=wcount-1; i++)
            {
                v = ae_v_dotproduct(&wt.ptr.p_float[i], 1, &hmod.ptr.pp_float[i][i], 1, ae_v_len(i,wcount-1));
                network->weights.ptr.p_float[i] = wbase.ptr.p_float[i]+v;
            }
            mlphessianbatch(network, xy, npoints, &e, &g, &h, _state);
            v = ae_v_dotproduct(&network->weights.ptr.p_float[0], 1, &network->weights.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
        ...
        {
            ebest = e;
            ae_v_move(&wbest.ptr.p_float[0], 1, &network->weights.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
        }
    }
     ...
     */
    ae_v_move(&network->weights.ptr.p_float[0], 1, &wbest.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    *info = 2;
    ...
    for(pass=1; pass<=restarts; pass++)
    {
         ...
         */
        mlprandomize(network, _state);
        ae_v_move(&w.ptr.p_float[0], 1, &network->weights.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
        ...
        ae_v_move(&network->weights.ptr.p_float[0], 1, &w.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    if( mlpissoftmax(network, _state) )
    {
        ...
        {
            if( ae_round(trnxy->ptr.pp_float[i][nin], _state)<0||ae_round(trnxy->ptr.pp_float[i][nin], _state)>=nout )
            {
                *info = -2;
                ae_frame_leave(_state);
                return;
        ...
        {
            if( ae_round(valxy->ptr.pp_float[i][nin], _state)<0||ae_round(valxy->ptr.pp_float[i][nin], _state)>=nout )
            {
                *info = -2;
                ae_frame_leave(_state);
                return;
    ...
    *info = 2;
    ...
    for(pass=1; pass<=restarts; pass++)
    {
        ...
        {
            ae_v_move(&wfinal.ptr.p_float[0], 1, &wbest.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
            efinal = ebest;
        }
    }
     ...
     * The best network
     */
    ae_v_move(&network->weights.ptr.p_float[0], 1, &wfinal.ptr.p_float[0], 1, ae_v_len(0,wcount-1));
    ae_frame_leave(_state);
}
    ...
    *info = 0;
    ...
    for(fold=0; fold<=foldscount-1; fold++)
    {
        ...
        for(i=0; i<=npoints-1; i++)
        {
            ...
            {
                ae_v_move(&testset.ptr.pp_float[tssize][0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,rowlen-1));
                tssize = tssize+1;
            }
            else
            {
                ae_v_move(&cvset.ptr.pp_float[cvssize][0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,rowlen-1));
                cvssize = cvssize+1;
            }
        }
        ...
        {
            ae_v_move(&x.ptr.p_float[0], 1, &testset.ptr.pp_float[i][0], 1, ae_v_len(0,nin-1));
            mlpprocess(&network, &x, &y, _state);
            if( mlpissoftmax(&network, _state) )
            {
                 ...
                 * Classification-specific code
                 */
                k = ae_round(testset.ptr.pp_float[i][nin], _state);
                for(j=0; j<=nout-1; j++)
                {
                    if( j==k )
                    {
                        cvrep->rmserror = cvrep->rmserror+ae_sqr(y.ptr.p_float[j]-1, _state);
                        cvrep->avgerror = cvrep->avgerror+ae_fabs(y.ptr.p_float[j]-1, _state);
                        cvrep->avgrelerror = cvrep->avgrelerror+ae_fabs(y.ptr.p_float[j]-1, _state);
                        relcnt = relcnt+1;
                    }
                    else
                    {
                        cvrep->rmserror = cvrep->rmserror+ae_sqr(y.ptr.p_float[j], _state);
                        cvrep->avgerror = cvrep->avgerror+ae_fabs(y.ptr.p_float[j], _state);
                    }
                }
            }
            else
            {
                ...
                for(j=0; j<=nout-1; j++)
                {
                    cvrep->rmserror = cvrep->rmserror+ae_sqr(y.ptr.p_float[j]-testset.ptr.pp_float[i][nin+j], _state);
                    cvrep->avgerror = cvrep->avgerror+ae_fabs(y.ptr.p_float[j]-testset.ptr.pp_float[i][nin+j], _state);
                    if( ae_fp_neq(testset.ptr.pp_float[i][nin+j],0) )
                    {
                        cvrep->avgrelerror = cvrep->avgrelerror+ae_fabs((y.ptr.p_float[j]-testset.ptr.pp_float[i][nin+j])/testset.ptr.pp_float[i][nin+j], _state);
                        relcnt = relcnt+1;
                    }
                }
            }
     ...
     ae_state *_state)
{
    ...
    {
        ensemble->weights.ptr.p_float[i] = ae_randomreal(_state)-0.5;
    }
    for(i=0; i<=ensemblesize-1; i++)
    {
        ae_v_move(&ensemble->columnmeans.ptr.p_float[i*ccount], 1, &network->columnmeans.ptr.p_float[0], 1, ae_v_len(i*ccount,(i+1)*ccount-1));
        ae_v_move(&ensemble->columnsigmas.ptr.p_float[i*ccount], 1, &network->columnsigmas.ptr.p_float[0], 1, ae_v_len(i*ccount,(i+1)*ccount-1));
    }
     ...
     ae_state *_state)
{
    ...
    ae_v_move(&ensemble2->weights.ptr.p_float[0], 1, &ensemble1->weights.ptr.p_float[0], 1, ae_v_len(0,ensemble1->ensemblesize*ensemble1->wcount-1));
    ae_v_move(&ensemble2->columnmeans.ptr.p_float[0], 1, &ensemble1->columnmeans.ptr.p_float[0], 1, ae_v_len(0,ensemble1->ensemblesize*ccount-1));
    ae_v_move(&ensemble2->columnsigmas.ptr.p_float[0], 1, &ensemble1->columnsigmas.ptr.p_float[0], 1, ae_v_len(0,ensemble1->ensemblesize*ccount-1));
    ae_v_move(&ensemble2->serializedmlp.ptr.p_float[0], 1, &ensemble1->serializedmlp.ptr.p_float[0], 1, ae_v_len(0,ensemble1->serializedlen-1));
}
     ...
     ae_state *_state)
{
    ...
    *rlen = hsize+ssize+ensemble->ensemblesize*ensemble->wcount+2*ccount*ensemble->ensemblesize+ensemble->serializedlen;
    ...
    ae_vector_set_length(ra, *rlen-1+1, _state);
    ra->ptr.p_float[0] = *rlen;
    ra->ptr.p_float[1] = mlpe_mlpevnum;
    ra->ptr.p_float[2] = ensemble->ensemblesize;
    ra->ptr.p_float[3] = ensemble->nin;
    ra->ptr.p_float[4] = ensemble->nout;
    ra->ptr.p_float[5] = ensemble->wcount;
    if( ensemble->issoftmax )
    {
        ra->ptr.p_float[6] = 1;
    }
    ...
    ra->ptr.p_float[8] = ssize;
    ra->ptr.p_float[9] = ntotal;
    ra->ptr.p_float[10] = ccount;
    ra->ptr.p_float[11] = hsize;
    ra->ptr.p_float[12] = ensemble->serializedlen;
    offs = hsize;
    for(i=offs; i<=offs+ssize-1; i++)
    {
        ra->ptr.p_float[i] = ensemble->structinfo.ptr.p_int[i-offs];
    }
    offs = offs+ssize;
    ae_v_move(&ra->ptr.p_float[offs], 1, &ensemble->weights.ptr.p_float[0], 1, ae_v_len(offs,offs+ensemble->ensemblesize*ensemble->wcount-1));
    offs = offs+ensemble->ensemblesize*ensemble->wcount;
    ae_v_move(&ra->ptr.p_float[offs], 1, &ensemble->columnmeans.ptr.p_float[0], 1, ae_v_len(offs,offs+ensemble->ensemblesize*ccount-1));
    offs = offs+ensemble->ensemblesize*ccount;
    ae_v_move(&ra->ptr.p_float[offs], 1, &ensemble->columnsigmas.ptr.p_float[0], 1, ae_v_len(offs,offs+ensemble->ensemblesize*ccount-1));
    offs = offs+ensemble->ensemblesize*ccount;
    ae_v_move(&ra->ptr.p_float[offs], 1, &ensemble->serializedmlp.ptr.p_float[0], 1, ae_v_len(offs,offs+ensemble->serializedlen-1));
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_round(ra->ptr.p_float[1], _state)==mlpe_mlpevnum, "MLPEUnserialize: incorrect array!", _state);
    
    /*
     * load info
     */
    hsize = 13;
    ensemble->ensemblesize = ae_round(ra->ptr.p_float[2], _state);
    ensemble->nin = ae_round(ra->ptr.p_float[3], _state);
    ensemble->nout = ae_round(ra->ptr.p_float[4], _state);
    ensemble->wcount = ae_round(ra->ptr.p_float[5], _state);
    ensemble->issoftmax = ae_round(ra->ptr.p_float[6], _state)==1;
    ensemble->postprocessing = ae_round(ra->ptr.p_float[7], _state)==1;
    ssize = ae_round(ra->ptr.p_float[8], _state);
    ntotal = ae_round(ra->ptr.p_float[9], _state);
    ccount = ae_round(ra->ptr.p_float[10], _state);
    offs = ae_round(ra->ptr.p_float[11], _state);
    ensemble->serializedlen = ae_round(ra->ptr.p_float[12], _state);
    ...
    for(i=offs; i<=offs+ssize-1; i++)
    {
        ensemble->structinfo.ptr.p_int[i-offs] = ae_round(ra->ptr.p_float[i], _state);
    }
    offs = offs+ssize;
    ae_v_move(&ensemble->weights.ptr.p_float[0], 1, &ra->ptr.p_float[offs], 1, ae_v_len(0,ensemble->ensemblesize*ensemble->wcount-1));
    offs = offs+ensemble->ensemblesize*ensemble->wcount;
    ae_v_move(&ensemble->columnmeans.ptr.p_float[0], 1, &ra->ptr.p_float[offs], 1, ae_v_len(0,ensemble->ensemblesize*ccount-1));
    offs = offs+ensemble->ensemblesize*ccount;
    ae_v_move(&ensemble->columnsigmas.ptr.p_float[0], 1, &ra->ptr.p_float[offs], 1, ae_v_len(0,ensemble->ensemblesize*ccount-1));
    offs = offs+ensemble->ensemblesize*ccount;
    ae_v_move(&ensemble->serializedmlp.ptr.p_float[0], 1, &ra->ptr.p_float[offs], 1, ae_v_len(0,ensemble->serializedlen-1));
    offs = offs+ensemble->serializedlen;
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=es-1; i++)
    {
        ae_v_move(&ensemble->tmpweights.ptr.p_float[0], 1, &ensemble->weights.ptr.p_float[i*wc], 1, ae_v_len(0,wc-1));
        ae_v_move(&ensemble->tmpmeans.ptr.p_float[0], 1, &ensemble->columnmeans.ptr.p_float[i*cc], 1, ae_v_len(0,cc-1));
        ae_v_move(&ensemble->tmpsigmas.ptr.p_float[0], 1, &ensemble->columnsigmas.ptr.p_float[i*cc], 1, ae_v_len(0,cc-1));
        ...
        ae_v_addd(&y->ptr.p_float[0], 1, &ensemble->y.ptr.p_float[0], 1, ae_v_len(0,ensemble->nout-1), v);
    }
}
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    if( ensemble->issoftmax )
    {
        for(i=0; i<=npoints-1; i++)
        {
            if( ae_round(xy->ptr.pp_float[i][ensemble->nin], _state)<0||ae_round(xy->ptr.pp_float[i][ensemble->nin], _state)>=ensemble->nout )
            {
                *info = -2;
                ae_frame_leave(_state);
                return;
    ...
    *info = 6;
    ...
    for(k=0; k<=ensemble->ensemblesize-1; k++)
    {
        ...
        do
        {
            ...
            for(i=0; i<=npoints-1; i++)
            {
                if( ae_fp_less(ae_randomreal(_state),0.66) )
                {
                     ...
                     */
                    ae_v_move(&trnxy.ptr.pp_float[trnsize][0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,ccount-1));
                    trnsize = trnsize+1;
                }
                else
                {
                     ...
                     */
                    ae_v_move(&valxy.ptr.pp_float[valsize][0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,ccount-1));
                    valsize = valsize+1;
                }
            }
        }
         ...
         * save results
         */
        ae_v_move(&ensemble->weights.ptr.p_float[k*ensemble->wcount], 1, &network.weights.ptr.p_float[0], 1, ae_v_len(k*ensemble->wcount,(k+1)*ensemble->wcount-1));
        ae_v_move(&ensemble->columnmeans.ptr.p_float[k*pcount], 1, &network.columnmeans.ptr.p_float[0], 1, ae_v_len(k*pcount,(k+1)*pcount-1));
        ae_v_move(&ensemble->columnsigmas.ptr.p_float[k*pcount], 1, &network.columnsigmas.ptr.p_float[0], 1, ae_v_len(k*pcount,(k+1)*pcount-1));
     ...
     ae_state *_state)
{
    ...
    *avgrel = 0;
    ...
    for(i=0; i<=npoints-1; i++)
    {
        ae_v_move(&workx.ptr.p_float[0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,ensemble->nin-1));
        mlpeprocess(ensemble, &workx, &y, _state);
        if( ensemble->issoftmax )
        {
            dy.ptr.p_float[0] = xy->ptr.pp_float[i][ensemble->nin];
        }
        else
        {
            ae_v_move(&dy.ptr.p_float[0], 1, &xy->ptr.pp_float[i][ensemble->nin], 1, ae_v_len(0,ensemble->nout-1));
        }
        dserraccumulate(&buf, &y, &dy, _state);
    }
    dserrfinish(&buf, _state);
    ...
    *info = 2;
    ...
    for(k=0; k<=ensemble->ensemblesize-1; k++)
    {
        ...
        for(i=0; i<=npoints-1; i++)
        {
            ...
            ae_v_move(&xys.ptr.pp_float[i][0], 1, &xy->ptr.pp_float[j][0], 1, ae_v_len(0,ccnt-1));
        }
        ...
        rep->ncholesky = rep->ncholesky+tmprep.ncholesky;
        ae_v_move(&ensemble->weights.ptr.p_float[k*ensemble->wcount], 1, &network.weights.ptr.p_float[0], 1, ae_v_len(k*ensemble->wcount,(k+1)*ensemble->wcount-1));
        ae_v_move(&ensemble->columnmeans.ptr.p_float[k*pcnt], 1, &network.columnmeans.ptr.p_float[0], 1, ae_v_len(k*pcnt,(k+1)*pcnt-1));
        ae_v_move(&ensemble->columnsigmas.ptr.p_float[k*pcnt], 1, &network.columnsigmas.ptr.p_float[0], 1, ae_v_len(k*pcnt,(k+1)*pcnt-1));
        ...
        for(i=0; i<=npoints-1; i++)
        {
            if( !s.ptr.p_bool[i] )
            {
                ae_v_move(&x.ptr.p_float[0], 1, &xy->ptr.pp_float[i][0], 1, ae_v_len(0,nin-1));
                mlpprocess(&network, &x, &y, _state);
                ae_v_add(&oobbuf.ptr.pp_float[i][0], 1, &y.ptr.p_float[0], 1, ae_v_len(0,nout-1));
    ...
    for(i=0; i<=npoints-1; i++)
    {
        ...
        {
            v = (float)1/(float)oobcntbuf.ptr.p_int[i];
            ae_v_moved(&y.ptr.p_float[0], 1, &oobbuf.ptr.pp_float[i][0], 1, ae_v_len(0,nout-1), v);
            if( ensemble->issoftmax )
            {
                dy.ptr.p_float[0] = xy->ptr.pp_float[i][nin];
            }
            else
            {
                ae_v_moved(&dy.ptr.p_float[0], 1, &xy->ptr.pp_float[i][nin], 1, ae_v_len(0,nout-1), v);
            }
            dserraccumulate(&dsbuf, &y, &dy, _state);
        }
    }
    dserrfinish(&dsbuf, _state);
    ooberrors->relclserror = dsbuf.ptr.p_float[0];
    ooberrors->avgce = dsbuf.ptr.p_float[1];
    ooberrors->rmserror = dsbuf.ptr.p_float[2];
    ooberrors->avgerror = dsbuf.ptr.p_float[3];
    ooberrors->avgrelerror = dsbuf.ptr.p_float[4];
    ae_frame_leave(_state);
}
     ...
     ae_state *_state)
{
    ...
    *info = 1;
    ...
    if( npoints==0 )
    {
        ...
        for(i=0; i<=nvars-1; i++)
        {
            for(j=0; j<=nvars-1; j++)
            {
                if( i==j )
                {
                    v->ptr.pp_float[i][j] = 1;
                }
                else
                {
                    v->ptr.pp_float[i][j] = 0;
                }
            }
        }
        ae_frame_leave(_state);
    ...
    for(j=0; j<=nvars-1; j++)
    {
        ae_v_move(&t.ptr.p_float[0], 1, &x->ptr.pp_float[0][j], x->stride, ae_v_len(0,npoints-1));
        samplemoments(&t, npoints, &mean, &variance, &skewness, &kurtosis, _state);
        m.ptr.p_float[j] = mean;
    }
    ...
    for(i=0; i<=npoints-1; i++)
    {
        ae_v_move(&a.ptr.pp_float[i][0], 1, &x->ptr.pp_float[i][0], 1, ae_v_len(0,nvars-1));
        ae_v_sub(&a.ptr.pp_float[i][0], 1, &m.ptr.p_float[0], 1, ae_v_len(0,nvars-1));
    }
    for(i=npoints; i<=nvars-1; i++)
    {
        for(j=0; j<=nvars-1; j++)
        {
            a.ptr.pp_float[i][j] = 0;
        }
    }
    ...
    if( npoints!=1 )
    {
        for(i=0; i<=nvars-1; i++)
        {
            s2->ptr.p_float[i] = ae_sqr(s2->ptr.p_float[i], _state)/(npoints-1);
        }
    }
    ae_matrix_set_length(v, nvars-1+1, nvars-1+1, _state);

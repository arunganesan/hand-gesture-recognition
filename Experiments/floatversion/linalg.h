...
INPUT PARAMETERS
  ...
  -- ALGLIB routine --
     ...
     Bochkanov Sergey
*************************************************************************/
void cmatrixsyrk(const ae_int_t n, const ae_int_t k, const float alpha, const complex_2d_array &a, const ae_int_t ia, const ae_int_t ja, const ae_int_t optypea, const float beta, complex_2d_array &c, const ae_int_t ic, const ae_int_t jc, const bool isupper);
...
OpType may be only 0 or 1.
  ...
  -- ALGLIB routine --
     ...
     Bochkanov Sergey
*************************************************************************/
void rmatrixsyrk(const ae_int_t n, const ae_int_t k, const float alpha, const real_2d_array &a, const ae_int_t ia, const ae_int_t ja, const ae_int_t optypea, const float beta, real_2d_array &c, const ae_int_t ic, const ae_int_t jc, const bool isupper);
